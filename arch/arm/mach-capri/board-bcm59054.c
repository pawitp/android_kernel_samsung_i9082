...
#include <CAPRI_SS_CRATER/board-bcm59054_config.h>
#else
#include <BASE/board-bcm59054_config.h>
#endif
...
static struct bcmpmu_platform_data bcmpmu_plat_data = {
	...
	.num_of_regl = ARRAY_SIZE(bcm59054_regulators),
	.regulator_init_data = &bcm59054_regulators[0],
	.fg_smpl_rate = 2083,
	.fg_slp_rate = 32000,
	.fg_slp_curr_ua = 1000,
	.fg_factor = 976,
	...
	.fg_fbat_lvl = 4140,
	.fg_low_cal_lvl = 3550,
#if defined(CONFIG_USB_SWITCH_FSA9485) || defined(CONFIG_USB_SWITCH_TSU6721)
	.bc = BCMPMU_BC_FSA,
#else
...
#ifdef CONFIG_CHARGER_BCMPMU_SPA
	.piggyback_chrg = 1,
	.piggyback_chrg_name = "bcm59054_charger",
