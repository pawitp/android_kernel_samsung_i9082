...
/* Regulator configuration */
	...
	{.map = 0, .addr = 0x97, .val = 0xB6, .mask = 0xff},//camldo1 3v
...
#if defined (CONFIG_CAPRI_SS_REV03) || (CONFIG_MACH_CAPRI_SS_BAFFIN) || (CONFIG_MACH_CAPRI_SS_ARUBA) || (CONFIG_MACH_CAPRI_SS_CRATER)
...
static struct regulator_init_data bcm59054_usbldo_data =  {
	.constraints = {
		.name = "usbldo",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_rfldo_data =  {
	.constraints = {
		.name = "rfldo",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_camldo1_data = {
	.constraints = {
		.name = "camldo1",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_camldo2_data = {
	.constraints = {
		.name = "camldo2",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_sdldo_data = {
	.constraints = {
		.name = "sdldo",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_sdxldo_data = {
	.constraints = {
		.name = "sdxldo",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_vibldo_data = {
	.constraints = {
		.name = "vibldo",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_audldo_data = {
	.constraints = {
		.name = "audldo",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_micldo_data = {
	.constraints = {
		.name = "micldo",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_mmcldo1_data = {
	.constraints = {
		.name = "mmcldo1",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_mmcldo2_data = {
	.constraints = {
		.name = "mmcldo2",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_simldo_data = {
	.constraints = {
		.name = "simldo",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_sim2ldo_data = {
	.constraints = {
		.name = "sim2ldo",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_hdmildo_data =  {
	.constraints = {
		.name = "hdmildo",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
		.always_on = 1,
...
static struct regulator_init_data bcm59054_csr_data = {
	.constraints = {
		.name = "csr",
		.min_uV = 700000,
		.max_uV = 1440000,
...
static struct regulator_init_data bcm59054_mmsr_data = {
	.constraints = {
		.name = "mmsr",
		.min_uV = 860000,
		.max_uV = 1800000,
...
static struct regulator_init_data bcm59054_vsr_data = {
	.constraints = {
		.name = "vsr",
		.min_uV = 860000,
		.max_uV = 1800000,
...
static struct regulator_init_data bcm59054_gpldo1_data = {
	.constraints = {
		.name = "gpldo1",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
struct regulator_consumer_supply gp2_supply[] = {
	{.supply = "gpldo2_uc"},
	REGULATOR_SUPPLY("vt_vdd", NULL), /* VT_CORE VDD */
};
static struct regulator_init_data bcm59054_gpldo2_data = {
	.constraints = {
		.name = "gpldo2",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_gpldo3_data = {
	.constraints = {
		.name = "gpldo3",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_tcxldo_data = {
	.constraints = {
		.name = "gpldo4",
		.min_uV = 1200000,
		.max_uV = 3300000,
...
static struct regulator_init_data bcm59054_lvldo1_data = {
	.constraints = {
		.name = "gpldo5",
		.min_uV = 1000000,
		.max_uV = 1786000,
...
struct regulator_consumer_supply gp6_supply[] = {
	{.supply = "gpldo6_uc"},
	REGULATOR_SUPPLY("8m_cam_vdd", NULL), /* 8M CAM VDD */
	
};
static struct regulator_init_data bcm59054_lvldo2_data = {
	.constraints = {
		.name = "gpldo6",
		.min_uV = 1000000,
		.max_uV = 1786000,
...
struct bcmpmu_regulator_init_data bcm59054_regulators[BCMPMU_REGULATOR_MAX] = {
	[BCMPMU_REGULATOR_RFLDO] = {
		BCMPMU_REGULATOR_RFLDO, &bcm59054_rfldo_data, 0x2A, 0
	},
	[BCMPMU_REGULATOR_CAMLDO] = {
		BCMPMU_REGULATOR_CAMLDO, &bcm59054_camldo1_data, 0xff, 1
	},
	[BCMPMU_REGULATOR_CAMLDO2] = {
		BCMPMU_REGULATOR_CAMLDO2, &bcm59054_camldo2_data, 0x02, 1
	},
	[BCMPMU_REGULATOR_SDLDO] = {
		BCMPMU_REGULATOR_SDLDO, &bcm59054_sdldo_data, 0x01, 1
	},
	[BCMPMU_REGULATOR_SDXLDO] = {
		BCMPMU_REGULATOR_SDXLDO, &bcm59054_sdxldo_data, 0x01, 1
	},
	[BCMPMU_REGULATOR_VIBLDO] = {
		BCMPMU_REGULATOR_VIBLDO, &bcm59054_vibldo_data, 0xAA, 0
	},
	[BCMPMU_REGULATOR_AUDLDO] = {
		BCMPMU_REGULATOR_AUDLDO, &bcm59054_audldo_data, 0x02, 0
	},
	[BCMPMU_REGULATOR_MICLDO] = {
		BCMPMU_REGULATOR_MICLDO, &bcm59054_micldo_data, 0xAA, 0
	},
	[BCMPMU_REGULATOR_MMCLDO1] = {
		BCMPMU_REGULATOR_MMCLDO1, &bcm59054_mmcldo1_data, 0x02, BCMPMU_REGL_OFF_IN_DSM
	},
	[BCMPMU_REGULATOR_MMCLDO2] = {
		BCMPMU_REGULATOR_MMCLDO2, &bcm59054_mmcldo2_data, 0xff, BCMPMU_REGL_LPM_IN_DSM
	},
	[BCMPMU_REGULATOR_SIMLDO] = {
		BCMPMU_REGULATOR_SIMLDO, &bcm59054_simldo_data, 0x01, BCMPMU_REGL_LPM_IN_DSM
	},
	[BCMPMU_REGULATOR_SIM2LDO] = {
		BCMPMU_REGULATOR_SIM2LDO, &bcm59054_sim2ldo_data, 0x01, BCMPMU_REGL_LPM_IN_DSM
	},
	[BCMPMU_REGULATOR_HDMILDO] = {
		BCMPMU_REGULATOR_HDMILDO, &bcm59054_hdmildo_data, 0x00, 0
	},
	[BCMPMU_REGULATOR_USBLDO] = {
		BCMPMU_REGULATOR_USBLDO, &bcm59054_usbldo_data, 0x01, BCMPMU_REGL_LPM_IN_DSM
	},
	[BCMPMU_REGULATOR_CSR_NM] = {
		BCMPMU_REGULATOR_CSR_NM, &bcm59054_csr_data, 0x00, 0
	},
	[BCMPMU_REGULATOR_MMSR_NM] = {
		BCMPMU_REGULATOR_MMSR_NM, &bcm59054_mmsr_data, 0x01, 0
	},
	[BCMPMU_REGULATOR_VSR_NM] = {
		BCMPMU_REGULATOR_VSR_NM, &bcm59054_vsr_data, 0x02, 0
	},
	[BCMPMU_REGULATOR_GPLDO1] = {
		BCMPMU_REGULATOR_GPLDO1, &bcm59054_gpldo1_data, 0xAA, 1
	},
	[BCMPMU_REGULATOR_GPLDO2] = {
		BCMPMU_REGULATOR_GPLDO2, &bcm59054_gpldo2_data, 0xAA, 1
	},
	[BCMPMU_REGULATOR_GPLDO3] = {
		BCMPMU_REGULATOR_GPLDO3, &bcm59054_gpldo3_data, 0xAA, 1
	},
	[BCMPMU_REGULATOR_GPLDO4] = {
		BCMPMU_REGULATOR_GPLDO4, &bcm59054_tcxldo_data, 0xFF, 1
	},
	[BCMPMU_REGULATOR_GPLDO5] = {
		BCMPMU_REGULATOR_GPLDO5, &bcm59054_lvldo1_data, 0xAA, 1
	},
	[BCMPMU_REGULATOR_GPLDO6] = {
		BCMPMU_REGULATOR_GPLDO6, &bcm59054_lvldo2_data, 0xAA, 1
	},
};
