 ...
 */
#if defined(CONFIG_MACH_CAPRI_SS_S2VE_REV03) || \
	defined(CONFIG_MACH_CAPRI_SS_S2VE_REV05) || \
	defined(CONFIG_MACH_CAPRI_SS_S2VE_REV06) || \
	defined(CONFIG_MACH_CAPRI_SS_S2VE_REV07) || \
	defined(CONFIG_MACH_CAPRI_SS_S2VE_REV05_4330) || \
	defined(CONFIG_MACH_CAPRI_SS_S2VEP_REV05)
#define GPIO_KEYS_SETTINGS { \
	{ KEY_HOME, 63, 1, "HOME", EV_KEY, 1, 64}, \
