...
/*
 * Platform-dependent ADC register value to temperature mapping table. Data
 * provided by MAP hardware team on 2012.09.13 by Anu Soni, Peter Lin, et al.
 * in the form of {<ADC value>, <temperature in degree C * 10>}
 */
	{908, -200},			/* -20 C */
	{896, -150},			/* -15 C */
	{867, -100},			/* -10 C */
...
struct regulator_consumer_supply cam1_supply[] = {
	...
	REGULATOR_SUPPLY("vdd", "1-000e"), /* ami306 */
	REGULATOR_SUPPLY("vdd", "1-0068"), /* mpu6050 */
	REGULATOR_SUPPLY("vdd", "1-0077"), /* bmp18x */
	REGULATOR_SUPPLY("vdd", "1-001d"), /* al3006 */
};
...
struct regulator_consumer_supply boost_supply_5v[] = {
	{.supply = "5v_vbush"},
	REGULATOR_SUPPLY("5v_lcd", "1-0004"), /* egalax touchscreen */
};
static struct regulator_init_data boost_5v = {
	.constraints = {
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
		.boot_on = 0,
		.always_on = 0,
	},
	.num_consumer_supplies = ARRAY_SIZE(boost_supply_5v),
	.consumer_supplies = boost_supply_5v,
};
#define HW_BOOST_5V_PARAM \
	.supply_name = "5v_boost", \
	.microvolts = 5000000, \
	.gpio = 55, \
	.startup_delay = 0, \
	.enable_high = 1, \
...
struct bcmpmu_regulator_init_data bcm59056_regulators[BCMPMU_REGULATOR_MAX] = {
	...
	[BCMPMU_REGULATOR_CAMLDO] = {
		BCMPMU_REGULATOR_CAMLDO, &bcm59056_camldo1_data, 0x01, 1
	},
	[BCMPMU_REGULATOR_CAMLDO2] = {
		BCMPMU_REGULATOR_CAMLDO2, &bcm59056_camldo2_data, 0x01, 1
	},
	[BCMPMU_REGULATOR_SDLDO] = {
		BCMPMU_REGULATOR_SDLDO, &bcm59056_sdldo_data, 0xff, 1
	},
	[BCMPMU_REGULATOR_SDXLDO] = {
		BCMPMU_REGULATOR_SDXLDO, &bcm59056_sdxldo_data, 0xff, 1
	},
	[BCMPMU_REGULATOR_VIBLDO] = {
		BCMPMU_REGULATOR_VIBLDO, &bcm59056_vibldo_data, 0xff, 1
	},
	[BCMPMU_REGULATOR_AUDLDO] = {
		BCMPMU_REGULATOR_AUDLDO, &bcm59056_audldo_data, 0x02, 3
	},
	[BCMPMU_REGULATOR_MICLDO] = {
		BCMPMU_REGULATOR_MICLDO, &bcm59056_micldo_data, 0xff, 1
	},
	[BCMPMU_REGULATOR_MMCLDO1] = {
		BCMPMU_REGULATOR_MMCLDO1, &bcm59056_mmcldo1_data, 0xff, 0
	},
	...
	[BCMPMU_REGULATOR_HDMILDO] = {
		BCMPMU_REGULATOR_HDMILDO, &bcm59056_hdmildo_data, 0xff, 0
	},
	[BCMPMU_REGULATOR_USBLDO] = {
		BCMPMU_REGULATOR_USBLDO, &bcm59056_usbldo_data, 0xff, 1
	},
	...
	[BCMPMU_REGULATOR_GPLDO1] = {
		BCMPMU_REGULATOR_GPLDO1, &bcm59056_gpldo1_data, 0xff, 0
	},
	[BCMPMU_REGULATOR_GPLDO2] = {
		BCMPMU_REGULATOR_GPLDO2, &bcm59056_gpldo2_data, 0xff, 0
	},
	[BCMPMU_REGULATOR_GPLDO3] = {
		BCMPMU_REGULATOR_GPLDO3, &bcm59056_gpldo3_data, 0xff, 0
	},
	[BCMPMU_REGULATOR_GPLDO4] = {
		BCMPMU_REGULATOR_GPLDO4, &bcm59056_gpldo4_data, 0xff, 0
	},
	[BCMPMU_REGULATOR_GPLDO5] = {
		BCMPMU_REGULATOR_GPLDO5, &bcm59056_gpldo5_data, 0xff, 0
	},
	[BCMPMU_REGULATOR_GPLDO6] = {
		BCMPMU_REGULATOR_GPLDO6, &bcm59056_gpldo6_data, 0xff, 0
	},
};
