...
#define HW_EGALAX_GPIO_RESET    0 	/* TSC_RST_B */
#define HW_EGALAX_GPIO_EVENT    1	/* TSC_INT_B */
#define HW_EGALAX_RESET_MSECS   1500
#define HW_EGALAX_RESET_LEVEL   0   /* Reset is applied */
