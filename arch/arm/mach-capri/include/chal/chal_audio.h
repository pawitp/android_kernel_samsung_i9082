...
*****************************************************************************/
extern void chal_audio_init(CHAL_HANDLE handle, uint32_t audioh_base,
			    uint32_t sdt_base);
...
*  @return CHAL handle for the Audio
*****************************************************************************/
extern void chal_aci_auxmic_init(CHAL_HANDLE handle, uint32_t aci_base,
				 uint32_t auxmic_base);
...
extern void chal_audio_vinpath_int_enable(CHAL_HANDLE handle,
					  uint16_t thr_int_enable,
					  uint16_t err_int_enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_left_int_enable(CHAL_HANDLE handle,
					       uint16_t thr_int_enable,
					       uint16_t err_int_enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_left_dma_enable(CHAL_HANDLE handle,
					       _Bool dma_enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_left_get_dma_port_addr(CHAL_HANDLE handle,
						      uint32_t *dma_addr);
...
*****************************************************************************/
extern uint32_t chal_audio_vinpath_read_fifo(CHAL_HANDLE handle, uint32_t *src,
					     uint32_t length, _Bool ign_udf);
...
*  @return the number of words read from the fifo
*****************************************************************************/
extern uint32_t chal_audio_vinpath_left_read_fifo(CHAL_HANDLE handle,
						  uint32_t *src,
						  uint32_t length,
						  _Bool ign_udf);
...
*  @return None
*****************************************************************************/
extern void chal_audio_vinpath_int_clear(CHAL_HANDLE handle, _Bool thr_int,
					 _Bool err_int);
...
*  @return None
*****************************************************************************/
extern void chal_audio_vinpath_left_int_clear(CHAL_HANDLE handle, _Bool thr_int,
					      _Bool err_int);
...
extern void chal_audio_vinpath_set_cic_scale(CHAL_HANDLE handle,
					     uint32_t dmic1_scale,
					     uint32_t dmic2_scale);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vinpath_set_digimic_clkdelay(CHAL_HANDLE handle,
						    uint16_t delay);
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_left_int_enable(CHAL_HANDLE handle,
						uint16_t fifo_int_enable,
						uint16_t err_int_enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_left_dma_enable(CHAL_HANDLE handle,
						_Bool dma_enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_left_get_dma_port_addr(CHAL_HANDLE handle,
						       uint32_t *dma_addr);
...
*  @return the number of words read from the fifo
*****************************************************************************/
extern uint32_t chal_audio_nvinpath_read_fifo(CHAL_HANDLE handle, uint32_t *src,
					      uint32_t length, _Bool ign_udf);
...
*  @return the number of words read from the fifo
*****************************************************************************/
extern uint32_t chal_audio_nvinpath_left_read_fifo(CHAL_HANDLE handle,
						   uint32_t *src,
						   uint32_t length,
						   _Bool ign_udf);
...
*  @return None
*****************************************************************************/
extern void chal_audio_nvinpath_int_clear(CHAL_HANDLE handle, _Bool fifo_int,
					  _Bool err_int);
...
*  @return None
*****************************************************************************/
extern void chal_audio_nvinpath_left_int_clear(CHAL_HANDLE handle,
					       _Bool fifo_int, _Bool err_int);
...
extern void chal_audio_nvinpath_set_cic_scale(CHAL_HANDLE handle,
					      uint32_t dmic3_scale,
					      uint32_t dmic4_scale);
...
*  @return none
*****************************************************************************/
extern void chal_audio_nvinpath_set_digimic_clkdelay(CHAL_HANDLE handle,
						     uint16_t delay);
...
*  @return none
*****************************************************************************/
extern void chal_audio_hspath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres,
					     uint16_t thres_2);
...
*****************************************************************************/
extern uint32_t chal_audio_hspath_write_fifo(CHAL_HANDLE handle, uint32_t *src,
					     uint32_t length, _Bool ign_ovf);
...
extern void chal_audio_hspath_sdm_set_dither_poly(CHAL_HANDLE handle,
						  uint32_t hs_dither_poly_L,
						  uint32_t hs_dither_poly_R);
...
extern void chal_audio_hspath_sdm_set_dither_seed(CHAL_HANDLE handle,
						  uint32_t hs_dither_seed_L,
						  uint32_t hs_dither_seed_R);
...
*  @return None
*****************************************************************************/
extern void chal_audio_hspath_int_clear(CHAL_HANDLE handle, _Bool fifo_int,
					_Bool err_int);
...
*  @return none
*****************************************************************************/
extern void chal_audio_hspath_set_dac_pwr(CHAL_HANDLE handle,
...
*  @return none
*****************************************************************************/
extern void chal_audio_ihfpath_set_fifo_thres(CHAL_HANDLE handle,
					      uint16_t thres, uint16_t thres_2);
...
*  @return Number of words written to the FIFO
*****************************************************************************/
extern uint32_t chal_audio_ihfpath_write_fifo(CHAL_HANDLE handle, uint32_t *src,
					      uint32_t length, _Bool ign_ovf);
...
extern void chal_audio_ihfpath_sdm_set_dither_poly(CHAL_HANDLE handle,
						   uint32_t ihf_dither_poly_L,
						   uint32_t ihf_dither_poly_R);
...
extern void chal_audio_ihfpath_sdm_set_dither_seed(CHAL_HANDLE handle,
						   uint32_t ihf_dither_seed_L,
						   uint32_t ihf_dither_seed_R);
...
*  @return None
*****************************************************************************/
extern void chal_audio_ihfpath_int_clear(CHAL_HANDLE handle, _Bool fifo_int,
					 _Bool err_int);
...
*  @return none
*****************************************************************************/
extern void chal_audio_ihfpath_set_dac_pwr(CHAL_HANDLE handle,
					   uint16_t enable_chan);
...
*  @return Number of words written to the FIFO
*****************************************************************************/
extern uint32_t chal_audio_earpath_write_fifo(CHAL_HANDLE handle, uint32_t *src,
					      uint32_t length, _Bool ign_ovf);
...
*  @return None
*****************************************************************************/
extern void chal_audio_earpath_int_clear(CHAL_HANDLE handle, _Bool fifo_int,
					 _Bool err_int);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_set_slowramp_ctrl(CHAL_HANDLE handle,
						 uint16_t sr_ctrl);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_clear_slowramp_ctrl(CHAL_HANDLE handle,
						   uint16_t sr_ctrl);
/**
*
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_set_isolation_ctrl(CHAL_HANDLE handle,
						  uint16_t iso_ctrl);
...
*  @return none
*****************************************************************************/
extern void chal_audio_earpath_clear_isolation_ctrl(CHAL_HANDLE handle,
						    uint16_t iso_ctrl);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vibra_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres,
					    uint16_t thres_2);
...
*  @return Number of words written to the FIFO
*****************************************************************************/
extern uint32_t chal_audio_vibra_write_fifo(CHAL_HANDLE handle, uint32_t *src,
					    uint32_t length, _Bool ign_ovf);
...
*  @return None
*****************************************************************************/
extern void chal_audio_vibra_int_clear(CHAL_HANDLE handle, _Bool fifo_int,
				       _Bool err_int);
...
*  @return none
*****************************************************************************/
extern void chal_audio_vibra_set_dac_pwr(CHAL_HANDLE handle,
					 uint16_t enable_chan);
...
*  @return the number of words read from the fifo
*****************************************************************************/
extern uint32_t chal_audio_eancpath_read_fifo(CHAL_HANDLE handle, uint32_t *src,
					      uint32_t length, _Bool ign_udf);
...
*  @return none
*****************************************************************************/
extern void chal_audio_eancpath_set_input_mic(CHAL_HANDLE handle,
					      uint16_t dmic);
...
*  @return None
*****************************************************************************/
extern void chal_audio_eancpath_int_clear(CHAL_HANDLE handle, _Bool fifo_int,
					  _Bool err_int);
...
*  @return none
*****************************************************************************/
extern void chal_audio_stpath_load_filter(CHAL_HANDLE handle, uint32_t *coeff,
					  uint32_t length);
...
extern void chal_audio_stpath_set_sofslope(CHAL_HANDLE handle,
					   uint16_t sof_slope, uint16_t linear,
					   uint32_t slope);
...
*  @return none
*****************************************************************************/
extern void chal_audio_stpath_config_misc(CHAL_HANDLE handle, uint16_t clipping,
					  uint16_t dis_filter,
...
*  @return none
*****************************************************************************/
extern void chal_audio_stpath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres,
					     uint16_t thres_2);
...
*  @return the number of words read from the fifo
*****************************************************************************/
extern uint32_t chal_audio_stpath_read_fifo(CHAL_HANDLE handle, uint32_t *src,
					    uint32_t length, _Bool ign_udf);
...
*  @return None
*****************************************************************************/
extern void chal_audio_stpath_int_clear(CHAL_HANDLE handle, _Bool thr_int,
					_Bool err_int);
...
*  @return none
*****************************************************************************/
void chal_audio_enable_dac_paths(CHAL_HANDLE handle, uint32_t dac_mask,
				 uint16_t enable);
...
*  @return none
*****************************************************************************/
void chal_audio_enable_adc_paths(CHAL_HANDLE handle, uint32_t adc_mask,
				 uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_api_enable_dac(CHAL_HANDLE handle, uint32_t dac_mask,
				      uint16_t enable);
...
*  @return none
*****************************************************************************/
extern void chal_audio_api_enable_adc(CHAL_HANDLE handle, uint32_t adc_mask,
				      uint16_t enable);
...
*  @return 
*****************************************************************************/
extern void chal_audio_eancpath_enable_IIR_coef(CHAL_HANDLE handle,
						_Bool enable);
...
*  @return 
*****************************************************************************/
extern void chal_audio_eancpath_DIIR_shift(CHAL_HANDLE handle, uint32_t shift_H,
					   uint32_t shift_L);
...
*  @return 
*****************************************************************************/
extern void chal_audio_eancpath_AIIR_shift(CHAL_HANDLE handle, uint32_t shift_H,
					   uint32_t shift_L);
...
*  @return 
*****************************************************************************/
extern void chal_audio_eancpath_UIIR_shift(CHAL_HANDLE handle, uint32_t shift_H,
					   uint32_t shift_L);
...
*  @return 
*****************************************************************************/
extern void chal_audio_eancpath_enable_FIR_coef(CHAL_HANDLE handle,
						_Bool enable);
...
*  @return 
*****************************************************************************/
extern void chal_audio_hspath_sdm_enable_dither(CHAL_HANDLE handle,
						uint16_t enable);
...
*  @return 
*****************************************************************************/
extern void chal_audio_hspath_sdm_set_dither_strength(CHAL_HANDLE handle,
...
*  @return 
*****************************************************************************/
extern void chal_audio_ihfpath_sdm_enable_dither(CHAL_HANDLE handle,
						 uint16_t enable);
...
*  @return 
*****************************************************************************/
extern void chal_audio_ihfpath_sdm_enable_dither_gain(CHAL_HANDLE handle,
						      uint16_t gain_enable);
...
*  @return 
*****************************************************************************/
extern void chal_audio_ihfpath_sdm_set_dither_strength(CHAL_HANDLE handle,
						       uint16_t dither_streng_L,
						       uint16_t
						       dither_streng_R);
