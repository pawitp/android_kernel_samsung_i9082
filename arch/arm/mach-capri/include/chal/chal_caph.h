/*****************************************************************************
* Copyright (c) 2003-2012 Broadcom Corporation.  All rights reserved.
*
...
typedef enum {
	...
	CAPH_SSP5_TRIGGER = 0x38,
	CAPH_SSP4_TRIGGER = 0x40,
	CAPH_SSP6_TRIGGER = 0x48,
...
typedef enum {
	...
	CAPH_SRCM_CH5_L = 0x0010,	/* Used for stereo mode */
	CAPH_SRCM_CH5_R = 0x0020,	/* Used for stereo mode */
	CAPH_SRCM_PASSCH1_L = 0x0040,	/* Used for stereo mode */
	CAPH_SRCM_PASSCH1_R = 0x0080,	/* Used for stereo mode */
	CAPH_SRCM_PASSCH2_L = 0x0100,	/* Used for stereo mode */
	CAPH_SRCM_PASSCH2_R = 0x0200,	/* Used for stereo mode */
	CAPH_SRCM_PASSCH1_M = 0x0400,	/* Used for mono mode */
	CAPH_SRCM_PASSCH2_M = 0x0800,	/* Used for mono mode */
	CAPH_SRCM_PASSCH3_M = 0x1000,	/* Used for mono mode */
	CAPH_SRCM_PASSCH4_M = 0x2000	/* Used for mono mode */
