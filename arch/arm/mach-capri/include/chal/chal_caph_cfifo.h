...
*  @return uint32_t
*****************************************************************************/
uint32_t chal_caph_cfifo_get_fifo_addr(CHAL_HANDLE handle, CAPH_CFIFO_e fifo);
...
*  @return void
*****************************************************************************/
void chal_caph_cfifo_enable(CHAL_HANDLE handle, uint16_t fifo);
...
*  @return void
*****************************************************************************/
void chal_caph_cfifo_disable(CHAL_HANDLE handle, uint16_t fifo);
...
void chal_caph_cfifo_set_address(CHAL_HANDLE handle,
				 CAPH_CFIFO_e fifo, uint32_t address);
...
void chal_caph_cfifo_set_size(CHAL_HANDLE handle,
			      CAPH_CFIFO_e fifo, uint16_t size);
...
void chal_caph_cfifo_queue_add_fifo(CHAL_HANDLE handle,
				    uint16_t fifo, CAPH_CFIFO_QUEUE_e queue);
...
*  @return void
*****************************************************************************/
void chal_caph_cfifo_set_panic_timer(CHAL_HANDLE handle, uint8_t timeout);
...
*  @return void
*****************************************************************************/
void chal_caph_cfifo_set_arb(CHAL_HANDLE handle, uint32_t key);
...
void chal_caph_cfifo_set_fifo_thres(CHAL_HANDLE handle,
				    CAPH_CFIFO_e fifo,
				    uint16_t thres, uint16_t thres2);
...
*  @return void
*****************************************************************************/
void chal_caph_cfifo_clr_fifo(CHAL_HANDLE handle, uint16_t fifo);
...
*  @return void
*****************************************************************************/
void chal_caph_cfifo_int_enable(CHAL_HANDLE handle, uint16_t fifo);
...
*  @return void
*****************************************************************************/
void chal_caph_cfifo_int_disable(CHAL_HANDLE handle, uint16_t fifo);
...
*  @return void
*****************************************************************************/
void chal_caph_cfifo_int_err_enable(CHAL_HANDLE handle, uint16_t fifo);
...
*  @return void
*****************************************************************************/
void chal_caph_cfifo_int_err_disable(CHAL_HANDLE handle, uint16_t fifo);
...
*  @return uint32_t
*****************************************************************************/
uint32_t chal_caph_cfifo_read_timestamp(CHAL_HANDLE handle, CAPH_CFIFO_e fifo);
