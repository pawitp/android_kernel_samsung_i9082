...
*  @return void
*****************************************************************************/
void chal_caph_dma_enable(CHAL_HANDLE handle, uint16_t channel);
...
*  @return void
*****************************************************************************/
void chal_caph_dma_disable(CHAL_HANDLE handle, uint16_t channel);
...
*  @return void
*****************************************************************************/
void chal_caph_dma_free_channel(CHAL_HANDLE handle, CAPH_DMA_CHANNEL_e channel);
...
void chal_caph_dma_set_tsize(CHAL_HANDLE handle,
			     CAPH_DMA_CHANNEL_e channel, uint8_t tsize);
...
*  @return void
*****************************************************************************/
void chal_caph_dma_clr_channel_fifo(CHAL_HANDLE handle, uint16_t channel);
/**
*
...
*****************************************************************************/
CAPH_DMA_CHNL_FIFO_STATUS_e chal_caph_dma_read_ddrfifo_sw_status(CHAL_HANDLE
								 handle,
								 CAPH_DMA_CHANNEL_e
								 channel);
/**
...
*
****************************************************************************/
void chal_caph_dma_nonstop_enable(CHAL_HANDLE handle,
				  CAPH_DMA_CHANNEL_e channel);
