...
void chal_caph_intc_enable_cfifo_intr(CHAL_HANDLE handle,
				      uint16_t fifo, CAPH_ARM_DSP_e owner);
...
void chal_caph_intc_enable_dma_intr(CHAL_HANDLE handle,
				    uint16_t channel, CAPH_ARM_DSP_e owner);
...
*  @return uint16_t
*****************************************************************************/
uint16_t chal_caph_intc_read_dma_intr(CHAL_HANDLE handle, CAPH_ARM_DSP_e owner);
...
void chal_caph_intc_enable_ssp_intr(CHAL_HANDLE handle,
				    uint8_t ssp, CAPH_ARM_DSP_e owner);
...
void chal_caph_intc_set_ssp_int_detect_level(CHAL_HANDLE handle,
					     uint8_t ssp, uint8_t detectLevel);
...
*  @return void
*****************************************************************************/
void chal_caph_intc_clr_switch_intr(CHAL_HANDLE handle, CAPH_ARM_DSP_e owner);
...
void chal_caph_intc_enable_audioh_intr(CHAL_HANDLE handle,
				       uint8_t fifo, CAPH_ARM_DSP_e owner);
...
void chal_caph_intc_enable_tap_intr(CHAL_HANDLE handle,
				    uint8_t channel, CAPH_ARM_DSP_e owner);
...
*  @return uint8_t
*****************************************************************************/
uint8_t chal_caph_intc_read_tap_intr(CHAL_HANDLE handle, CAPH_ARM_DSP_e owner);
