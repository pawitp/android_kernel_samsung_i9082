...
*  @return void
*****************************************************************************/
void chal_caph_switch_enable(CHAL_HANDLE handle, uint16_t channel);
...
*  @return void
*****************************************************************************/
void chal_caph_switch_disable(CHAL_HANDLE handle, uint16_t channel);
...
void chal_caph_switch_set_clock0(CHAL_HANDLE handle,
				 uint8_t m_ratio, uint16_t n_ratio);
...
*  @return void
*****************************************************************************/
void chal_caph_switch_write_time(CHAL_HANDLE handle, uint8_t time);
