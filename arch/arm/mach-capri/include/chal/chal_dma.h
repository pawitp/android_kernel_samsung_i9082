...
******************************************************************************/
	typedef enum {
		...
		CHAL_DMA_STATUS_CACHE_MISS =
		    CHAL_DMA_REG_CHAN_STATUS_CACHE_MISS,
		CHAL_DMA_STATUS_WAITING =
		    CHAL_DMA_REG_CHAN_STATUS_WAIT_FOR_EVENT,
		CHAL_DMA_STATUS_WAITING_PERI =
		    CHAL_DMA_REG_CHAN_STATUS_WAIT_FOR_PERIPHERAL,
...
******************************************************************************/
	...
	typedef enum {
		CHAL_DMA_DESC_LIST = 0,	/* List of transfer */
		CHAL_DMA_DESC_RING = 1,	/* Continuous transfer */
		CHAL_DMA_DESC_PCTL = 2	/* Peripheral controlled transfer */
...
******************************************************************************/
	CHAL_CHANNEL_HANDLE chal_dma_config_channel
	    (CHAL_HANDLE handle,
	     CHAL_DMA_CHANNEL_t channel, CHAL_DMA_CHAN_CONFIG_t * config);
...
******************************************************************************/
	void chal_dma_config_channel_memory
	    (CHAL_CHANNEL_HANDLE handle,
	     uint32_t virtualAddr, uint32_t physicalAddr, uint32_t descCount);
...
******************************************************************************/
	void chal_dma_get_capabilities
	    (CHAL_HANDLE handle, CHAL_DMA_CAPABILITIES_t * pCap);
...
******************************************************************************/
	int chal_dma_get_current_channel_descriptor_index
	    (CHAL_CHANNEL_HANDLE handle, uint32_t *desc_idx);
...
******************************************************************************/
	CHAL_DMA_STATUS_t chal_dma_get_channel
	    (CHAL_HANDLE handle, CHAL_DMA_CHANNEL_t * channel);
...
******************************************************************************/
	CHAL_DMA_STATUS_t chal_dma_connect_peripheral
	    (CHAL_CHANNEL_HANDLE handle, CHAL_DMA_PERIPHERAL_t peripheral);
...
******************************************************************************/
	uint32_t chal_dma_calculate_channel_memory
	    (CHAL_CHANNEL_HANDLE handle, uint32_t descCount);
...
******************************************************************************/
	CHAL_DMA_STATUS_t chal_dma_add_descriptor
	    (CHAL_CHANNEL_HANDLE handle,
	     ...
	     uint32_t srcPhysicalAddr, uint32_t dstPhysicalAddr, uint32_t size);
...
******************************************************************************/
	CHAL_DMA_STATUS_t chal_dma_add_device_command_to_descriptor
	    (CHAL_CHANNEL_HANDLE handle,
	     _Bool firstDescriptor,
	     uint32_t srcPhysicalAddr, uint32_t dstPhysicalAddr);
...
*
******************************************************************************/
	CHAL_DMA_CHANNEL_t chal_dma_handle_to_channel(CHAL_CHANNEL_HANDLE
						      handle);
...
*  @note
******************************************************************************/
	CHAL_DMA_STATUS_t chal_dma_get_channel_status(CHAL_HANDLE handle);
...
*
*******************************************************************************/
	void chal_dma_dump_register(CHAL_CHANNEL_HANDLE handle,	/* [ IN ] DMA channel handle */
