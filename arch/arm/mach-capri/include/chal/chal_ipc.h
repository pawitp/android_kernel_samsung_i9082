...
/* function declarations */
	...
	BCM_ERR_CODE chal_ipc_query_wakeup_vc(CHAL_IPC_HANDLE handle,
					      uint32_t *result);

	BCM_ERR_CODE chal_ipc_wakeup_vc(CHAL_IPC_HANDLE handle,
					uint32_t address);
	...
	BCM_ERR_CODE chal_ipc_get_int_status(CHAL_IPC_HANDLE handle,
					     uint32_t *status);

	BCM_ERR_CODE chal_ipc_get_int_source(CHAL_IPC_HANDLE handle,
					     IPC_INTERRUPT_SOURCE * source);

	BCM_ERR_CODE chal_ipc_get_error_status(CHAL_IPC_HANDLE handle,
					       uint32_t *status);
