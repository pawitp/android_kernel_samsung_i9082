...
void chal_mqos_entry_config(CHAL_MQOS_t * mqos_data,
			    unsigned int entry_cfg_str,
			    unsigned int enable_cfg_str,
			    CHAL_MQOS_CAM_ENTRY_ID_e id);

void chal_mqos_enable(CHAL_MQOS_t * mqos_data,
		      unsigned int enable_cfg_str, CHAL_MQOS_CAM_ENTRY_ID_e id);

void chal_mqos_stop(CHAL_MQOS_t * mqos_data);

void chal_mqos_print_raw(CHAL_MQOS_t * mqos_data,
