...
******************************************************************************/
	typedef enum {
		CHAL_SSPI_BIT_RATE_64kHz = 0,
		CHAL_SSPI_BIT_RATE_128kHz = 1,
		CHAL_SSPI_BIT_RATE_256kHz = 2,
		CHAL_SSPI_BIT_RATE_352_8kHz = 3,
		CHAL_SSPI_BIT_RATE_512kHz = 4,
		CHAL_SSPI_BIT_RATE_600kHz = 5,
		CHAL_SSPI_BIT_RATE_705_6kHz = 6,
		CHAL_SSPI_BIT_RATE_1200kHz = 7,
		CHAL_SSPI_BIT_RATE_1411_2kHz = 8,
		CHAL_SSPI_BIT_RATE_1536kHz = 9,
		CHAL_SSPI_BIT_RATE_1600kHz = 10,
		CHAL_SSPI_BIT_RATE_2400kHz = 11,
		CHAL_SSPI_BIT_RATE_2822_4kHz = 12,
		CHAL_SSPI_BIT_RATE_3120kHz = 13,
		CHAL_SSPI_BIT_RATE_3200kHz = 14,
		CHAL_SSPI_BIT_RATE_4800kHz = 15,
		CHAL_SSPI_BIT_RATE_11140kHz = 16,
		CHAL_SSPI_BIT_RATE_12MHz = 17,
		CHAL_SSPI_BIT_RATE_12288kHz = 18,
		CHAL_SSPI_BIT_RATE_13MHz = 19,
		CHAL_SSPI_BIT_RATE_15600kHz = 20,
		CHAL_SSPI_BIT_RATE_19500kHz = 21,
		CHAL_SSPI_BIT_RATE_22280kHz = 22,
		CHAL_SSPI_BIT_RATE_24MHz = 23,
		CHAL_SSPI_BIT_RATE_26MHz = 24,
		CHAL_SSPI_BIT_RATE_31200kHz = 25,
		CHAL_SSPI_BIT_RATE_39MHz = 26,
		CHAL_SSPI_BIT_RATE_48MHz = 27,
		CHAL_SSPI_BIT_RATE_52MHz = 28,
