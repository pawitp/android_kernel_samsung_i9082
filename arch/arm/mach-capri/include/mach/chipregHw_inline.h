...
{
	return
	    reg32_read((volatile uint32_t *)(chipregHw_BASE_ADDRESS +
					     CHIPREG_CHIPID_REG_OFFSET));
}
...
static inline uint32_t chipregHw_getChipIdRev(void)
{
	return
	    reg32_read((volatile uint32_t *)(chipregHw_BASE_ADDRESS +
					     CHIPREG_CHIPID_REG_OFFSET)) & 0xff;
}
...
{
	reg32_write((volatile uint32_t *)(chipregHw_BASE_ADDRESS +
					  CHIPREG_CHIP_SW_STRAP_OFFSET),
		    strapOptions);
}
...
{
	return (chipregHw_getSoftwareStraps() &
		CHIPREG_CHIP_SW_STRAP_SW_STRAP_EN_MASK) >>
	    CHIPREG_CHIP_SW_STRAP_SW_STRAP_EN_SHIFT;
}
...
{
	reg32_set_bits((volatile uint32_t *)(chipregHw_BASE_ADDRESS +
					     CHIPREG_CHIP_SW_STRAP_OFFSET),
		       CHIPREG_CHIP_SW_STRAP_SW_STRAP_EN_MASK);
}
...
{
	reg32_clear_bits((volatile uint32_t *)(chipregHw_BASE_ADDRESS +
					       CHIPREG_CHIP_SW_STRAP_OFFSET),
			 CHIPREG_CHIP_SW_STRAP_SW_STRAP_EN_MASK);
}
...
static inline _Bool chipregHw_getStrapXtalOscBypass(void)
{
	if (chipregHw_isSoftwareStrapsEnable()) {
		return ((chipregHw_getSoftwareStraps() &
			 chipregHw_REG_STRAP_XTAL_OSC_BYPASS_MASK)
			>> chipregHw_REG_STRAP_XTAL_OSC_BYPASS_SHIFT);
	} else {
		return ((chipregHw_getHardwareStraps() &
			 chipregHw_REG_STRAP_XTAL_OSC_BYPASS_MASK)
			>> chipregHw_REG_STRAP_XTAL_OSC_BYPASS_SHIFT);
	}
}
...
static inline chipregHw_STRAP_ASIC_MODE_e chipregHw_getStrapAsicMode(void)
{
	if (chipregHw_isSoftwareStrapsEnable()) {
		return ((chipregHw_getSoftwareStraps() &
			 chipregHw_REG_STRAP_ASIC_MODE_MASK)
...
static inline chipregHw_STRAP_XTAL_TYPE_e chipregHw_getStrapXtalType(void)
{
	if (chipregHw_isSoftwareStrapsEnable()) {
		return ((chipregHw_getSoftwareStraps() &
			 chipregHw_REG_STRAP_XTAL_TYPE_MASK)
...
static inline chipregHw_STRAP_BOOT_OPTIONS_e chipregHw_getStrapBootMode(void)
{
	if (chipregHw_isSoftwareStrapsEnable()) {
		return ((chipregHw_getSoftwareStraps() &
			 chipregHw_REG_STRAP_BOOT_OPTIONS_MASK)
...
static inline _Bool chipregHw_getStrapOtpProgMode(void)
{
	if (chipregHw_isSoftwareStrapsEnable()) {
		return ((chipregHw_getSoftwareStraps() &
			 chipregHw_REG_STRAP_OTP_PROG_AND_STATUS_MASK)
...
static inline _Bool chipregHw_getStrapTmact(void)
{
	if (chipregHw_isSoftwareStrapsEnable()) {
		return ((chipregHw_getSoftwareStraps() &
			 chipregHw_REG_STRAP_TMACT_MASK)
...
static inline _Bool chipregHw_getStrapFlashboot(void)
{
	if (chipregHw_isSoftwareStrapsEnable()) {
		return ((chipregHw_getSoftwareStraps() &
			 chipregHw_REG_STRAP_FLASHBOOT_MASK)
...
/****************************************************************************/
/**
*  This function returns Capri ID/ Version
**/
/****************************************************************************/
