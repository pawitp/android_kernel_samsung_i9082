...
#define ESUB_RST_MGR_REG_EAV_SOFT_RSTN_OFFSET                             0x00000014
#define ESUB_RST_MGR_REG_EAV_SOFT_RSTN_TYPE                               UInt32
#define ESUB_RST_MGR_REG_EAV_SOFT_RSTN_RESERVED_MASK                      0x7FFFFFF0
#define    ESUB_RST_MGR_REG_EAV_SOFT_RSTN_PRIV_ACCESS_MODE_SHIFT          31
#define    ESUB_RST_MGR_REG_EAV_SOFT_RSTN_PRIV_ACCESS_MODE_MASK           0x80000000
#define    ESUB_RST_MGR_REG_EAV_SOFT_RSTN_EAV_AV_SOFT_RSTN_SHIFT          3
#define    ESUB_RST_MGR_REG_EAV_SOFT_RSTN_EAV_AV_SOFT_RSTN_MASK           0x00000008
#define    ESUB_RST_MGR_REG_EAV_SOFT_RSTN_EAV_AV_1_SOFT_RSTN_SHIFT        2
#define    ESUB_RST_MGR_REG_EAV_SOFT_RSTN_EAV_AV_1_SOFT_RSTN_MASK         0x00000004
#define    ESUB_RST_MGR_REG_EAV_SOFT_RSTN_EAV_AV_0_SOFT_RSTN_SHIFT        1
#define    ESUB_RST_MGR_REG_EAV_SOFT_RSTN_EAV_AV_0_SOFT_RSTN_MASK         0x00000002
#define    ESUB_RST_MGR_REG_EAV_SOFT_RSTN_EAV_AXI_SOFT_RSTN_SHIFT         0
#define    ESUB_RST_MGR_REG_EAV_SOFT_RSTN_EAV_AXI_SOFT_RSTN_MASK          0x00000001
