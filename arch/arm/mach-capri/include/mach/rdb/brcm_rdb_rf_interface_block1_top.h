...
#define RF_INTERFACE_BLOCK1_TOP_RXSCALING_OFFSET                          0x00000048
#define RF_INTERFACE_BLOCK1_TOP_RXSCALING_TYPE                            UInt32
#define RF_INTERFACE_BLOCK1_TOP_RXSCALING_RESERVED_MASK                   0xFFFFFFC0
#define    RF_INTERFACE_BLOCK1_TOP_RXSCALING_ENABLEPROGSCALE_SHIFT        5
#define    RF_INTERFACE_BLOCK1_TOP_RXSCALING_ENABLEPROGSCALE_MASK         0x00000020
#define    RF_INTERFACE_BLOCK1_TOP_RXSCALING_PROGSCALEVPCTRL_SHIFT        3
#define    RF_INTERFACE_BLOCK1_TOP_RXSCALING_PROGSCALEVPCTRL_MASK         0x00000018
#define    RF_INTERFACE_BLOCK1_TOP_RXSCALING_PROGSCALEFACTORSEL_SHIFT     0
#define    RF_INTERFACE_BLOCK1_TOP_RXSCALING_PROGSCALEFACTORSEL_MASK      0x00000007
