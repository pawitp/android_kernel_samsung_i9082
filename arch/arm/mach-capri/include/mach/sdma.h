...
static inline int sdma_transfer_mem_to_mem(SDMA_Handle_t handle,	/* DMA Handle */
					   dma_addr_t srcData,
					   /* Place to get data to write to device */
					   dma_addr_t dstData,
					   /* Pointer to device data address */
...
int sdma_set_device_handler_extended(DMA_Device_t dev,	/* Device to set the callback for. */
				     DMA_DeviceHandlerExt_t devHandlerExt,
				     /* Function to call when the DMA completes */
				     void *userData
