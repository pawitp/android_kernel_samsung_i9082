...
static struct pin_config rgmii1_config[] = {
	...
	PIN_RGMII_CFG(RGMII_1_RXC, RGMII_1_RXC, 0x50),
	PIN_RGMII_CFG(RGMII_1_RXD_3, RGMII_1_RXD3, 0x50),
	PIN_RGMII_CFG(RGMII_1_RXD_2, RGMII_1_RXD2, 0x50),
	PIN_RGMII_CFG(RGMII_1_RXD_1, RGMII_1_RXD1, 0x50),
	PIN_RGMII_CFG(RGMII_1_RXD_0, RGMII_1_RXD0, 0x50),
	PIN_RGMII_CFG(RGMII_1_RX_CTL, RGMII_1_RX_CTL, 0x50),
...
static struct pin_config ungrouped_pins_config[] = {
	...
	PIN_CFG(GPIO05, GPIO_005, 1, ON, OFF, 0, 0, 8MA),
	PIN_CFG(GPIO06, GPIO_006, 1, ON, OFF, 0, 0, 8MA),

	PIN_CFG(GPIO05, GPIO_091, 1, ON, OFF, 0, 0, 8MA),
	PIN_CFG(GPIO06, GPIO_092, 1, ON, OFF, 0, 0, 8MA),
	PIN_CFG(GPIO05, GPIO_093, 1, ON, OFF, 0, 0, 8MA),
	PIN_CFG(GPIO06, GPIO_094, 1, ON, OFF, 0, 0, 8MA),
...
static struct pin_config mii0_config[] = {
	PIN_RGMII_CFG(RGMII_0_TXD_3, RGMII_0_TXD3, 0x50),
	PIN_RGMII_CFG(RGMII_0_TXD_2, RGMII_0_TXD2, 0x50),
	PIN_RGMII_CFG(RGMII_0_TXD_1, RGMII_0_TXD1, 0x50),
	PIN_RGMII_CFG(RGMII_0_TXD_0, RGMII_0_TXD0, 0x50),
	PIN_RGMII_CFG(RGMII_0_TXC, RGMII_0_TXC, 0x50),
	PIN_RGMII_CFG(RGMII_0_TX_CTL, RGMII_0_TX_CTL, 0x50),
	PIN_RGMII_CFG(RGMII_0_RXC, RGMII_0_RXC, 0x50),
	PIN_RGMII_CFG(RGMII_0_RXD_3, RGMII_0_RXD3, 0x50),
	PIN_RGMII_CFG(RGMII_0_RXD_2, RGMII_0_RXD2, 0x50),
	PIN_RGMII_CFG(RGMII_0_RXD_1, RGMII_0_RXD1, 0x50),
	PIN_RGMII_CFG(RGMII_0_RXD_0, RGMII_0_RXD0, 0x50),
	PIN_RGMII_CFG(RGMII_0_RX_CTL, RGMII_0_RX_CTL, 0x50),
	PIN_RGMII_CFG(RGMII_GPIO_0, RGMII_GPIO_0, 0x50),
	PIN_RGMII_CFG(RGMII_GPIO_1, RGMII_GPIO_1, 0x50),
};

static struct pin_config mii1_config[] = {
	PIN_RGMII_CFG(RGMII_1_TXD_3, RGMII_1_TXD3, 0x50),
	PIN_RGMII_CFG(RGMII_1_TXD_2, RGMII_1_TXD2, 0x50),
	PIN_RGMII_CFG(RGMII_1_TXD_1, RGMII_1_TXD1, 0x50),
	PIN_RGMII_CFG(RGMII_1_TXD_0, RGMII_1_TXD0, 0x50),
	PIN_RGMII_CFG(RGMII_1_TXC, RGMII_1_TXC, 0x50),
	PIN_RGMII_CFG(RGMII_1_TX_CTL, RGMII_1_TX_CTL, 0x50),
	PIN_RGMII_CFG(RGMII_1_RXC, RGMII_1_RXC, 0x50),
	PIN_RGMII_CFG(RGMII_1_RXD_3, RGMII_1_RXD3, 0x50),
	PIN_RGMII_CFG(RGMII_1_RXD_2, RGMII_1_RXD2, 0x50),
	PIN_RGMII_CFG(RGMII_1_RXD_1, RGMII_1_RXD1, 0x50),
	PIN_RGMII_CFG(RGMII_1_RXD_0, RGMII_1_RXD0, 0x50),
	PIN_RGMII_CFG(RGMII_1_RX_CTL, RGMII_1_RX_CTL, 0x50),
	PIN_RGMII_CFG(RGMII_GPIO_2, RGMII_GPIO_2, 0x50),
	PIN_RGMII_CFG(RGMII_GPIO_3, RGMII_GPIO_3, 0x50),
};

static struct pin_config nand_config[] = {
...
const struct pin_group pin_config_list[] = {
	...
	PIN_GROUP_CFG(PG_RGMII1, rgmii1_config, ARRAY_LEN(rgmii1_config)),
	...
	PIN_GROUP_CFG(PG_MII0, mii0_config, ARRAY_LEN(mii0_config)),
	PIN_GROUP_CFG(PG_MII1, mii1_config, ARRAY_LEN(mii1_config)),
	PIN_GROUP_CFG(PG_NAND, nand_config, ARRAY_LEN(nand_config)),
...
//    pinmux_block_init(PG_BATT_CHRG);
