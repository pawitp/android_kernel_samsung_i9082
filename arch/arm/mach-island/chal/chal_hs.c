 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_enable(CHAL_HANDLE handle, uint16_t enable)
 * 
...
/*============================================================================*/
void chal_audio_hspath_enable(CHAL_HANDLE handle, uint16_t enable_chan)
{
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_int_enable(CHAL_HANDLE handle, uint16_t  thr_int_enable, uint16_t err_int_enable)
 * 
...
void chal_audio_hspath_int_enable(CHAL_HANDLE handle, uint16_t thr_int_enable, uint16_t err_int_enable)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t reg_val;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_dma_enable(CHAL_HANDLE handle, uint16_t dma_enable)
 * 
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_mute(CHAL_HANDLE handle, _Bool mute)
 * 
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_set_gain(CHAL_HANDLE handle, uint32_t gain)
 * 
...
void chal_audio_hspath_set_gain(CHAL_HANDLE handle, uint32_t gain)
{
   (void) handle;
   (void) gain;
   return;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits)
 * 
...
void chal_audio_hspath_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits)
{
    uint32_t     reg_val;
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_set_mono_stereo(CHAL_HANDLE handle, _Bool mode)
 * 
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_set_pack(CHAL_HANDLE handle, _Bool pack)
 * 
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2)
 * 
...
void chal_audio_hspath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2)
{
    uint32_t     reg_val;
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 * 
 *  Function Name: uint32_t chal_audio_hspath_read_fifo_status(CHAL_HANDLE handle)
 * 
...
uint32_t chal_audio_hspath_read_fifo_status(CHAL_HANDLE handle)
{
    uint32_t     reg_val;
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 * 
 *  Function Name: uint32_t chal_audio_hspath_read_int_status(CHAL_HANDLE handle)
 * 
...
uint32_t chal_audio_hspath_read_int_status(CHAL_HANDLE handle)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t     status = 0;
    uint32_t     reg_val = 0;
 ...
 * ============================================================================
 * 
 *  Function Name: chal_audio_hspath_write_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length)
 * 
...
uint32_t chal_audio_hspath_write_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_ovf)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t      n;
    ...
    if(ign_ovf == CHAL_AUDIO_STOP_ON_FIFO_OVERFLOW)
    {
        for(n = 0; n < length; n++)
        {
            ...
            BRCM_WRITE_REG(base,  AUDIOH_STEREO_FIFO_DATA, ((uint32_t) *src++));
        }
    }
    else
    {
 ...
 * ============================================================================
 * 
 *  Function Name: chal_audio_hspath_eanc_in(CHAL_HANDLE handle, uint16_t enable)
 * 
...
void chal_audio_hspath_eanc_in(CHAL_HANDLE handle, uint16_t enable )
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t     eanc_ctrl;
 ...
 * ============================================================================
 * 
 *  Function Name: chal_audio_hspath_sidetone_in(CHAL_HANDLE handle, uint16_t enable)
 * 
...
void chal_audio_hspath_sidetone_in(CHAL_HANDLE handle, uint16_t enable )
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t     reg_val = 0;
 ...
 * ============================================================================
 * 
 *  Function Name: void hal_audio_hspath_sdm_enable_dither_gain(CHAL_HANDLE handle,
 *                                    uint16_t gain_enable)
 * 
...
{
    uint32_t reg_val;
    uint32_t hs_dither_gain = 0x00000000;
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_sdm_set_dither_strength(CHAL_HANDLE handle,
 *                                    uint16_t dither_streng_L,
 *                                    uint16_t dither_streng_R);
 * 
 *  Description:  set the dither strength to sigma delta module on headset path
 * 
 *  Parameters:   handle - audio chal handle.
...
{
   uint32_t reg_val;
    uint32_t hs_dither_strngth = 0x00000000;
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 *                                 uint32_t hs_coef_L, uint32_t hs_coef_R)
 * 
...
void chal_audio_hspath_sdm_set_coef(CHAL_HANDLE handle, uint32_t hs_coef_L, uint32_t hs_coef_R)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_sdm_set_dither_poly(CHAL_HANDLE handle,
 *                                 uint32_t hs_dither_poly_L, uint32_t hs_dither_poly_R)
 * 
...
void chal_audio_hspath_sdm_set_dither_poly(CHAL_HANDLE handle, uint32_t hs_dither_poly_L, uint32_t hs_dither_poly_R)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t reg_value;
 ...
 *                                 uint32_t hs_dither_seed_L, uint32_t hs_dither_seed_R)
 * 
...
void chal_audio_hspath_sdm_set_dither_seed(CHAL_HANDLE handle, uint32_t hs_dither_seed_L, uint32_t hs_dither_seed_R)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_hs_supply_ctrl(CHAL_HANDLE handle, uint32_t vout_supply_ctrl)
 * 
...
void chal_audio_hspath_hs_supply_ctrl(CHAL_HANDLE handle, _Bool hs_ds_pol, uint8_t hs_ds_delay, uint8_t hs_ds_lag)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t hs_supply_ctl = 0x00000000;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_hs_supply_thres(CHAL_HANDLE handle, uint32_t hs_supply_thres)
 * 
...
void chal_audio_hspath_hs_supply_thres(CHAL_HANDLE handle, uint32_t hs_supply_thres)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_get_dma_port_addr(CHAL_HANDLE handle,
 *                                     uint32_t *dma_addr)
 * 
...
void chal_audio_hspath_get_dma_port_addr(CHAL_HANDLE handle, uint32_t *dma_addr)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;

	*dma_addr = (uint32_t)(base) + AUDIOH_STEREO_FIFO_DATA_OFFSET;
 ...
 * ============================================================================
 * 
 *  Function Name: uint32_t chal_audio_hspath_get_dma_port_addr_offset()
 * 
 ...
 * ============================================================================
 */
uint32_t chal_audio_hspath_get_dma_port_addr_offset( void )
{
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_int_clear(CHAL_HANDLE handle, _Bool thr_int, _Bool err_int )
 * 
 ...
 * ============================================================================
 */
void chal_audio_hspath_int_clear(CHAL_HANDLE handle, _Bool thr_int, _Bool err_int)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t reg_val = 0;
...
void chal_audio_hspath_set_dac_pwr(CHAL_HANDLE handle, uint16_t enable_chan)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t reg_value;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_hspath_set_filter(CHAL_HANDLE handle, uint16_t filter)
 * 
...
/*============================================================================*/
void chal_audio_hspath_set_filter(CHAL_HANDLE handle, uint16_t filter)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t reg_val;
...
EXPORT_SYMBOL(chal_audio_hspath_enable);
EXPORT_SYMBOL(chal_audio_hspath_int_enable);
EXPORT_SYMBOL(chal_audio_hspath_dma_enable);
EXPORT_SYMBOL(chal_audio_hspath_get_dma_port_addr);
EXPORT_SYMBOL(chal_audio_hspath_get_dma_port_addr_offset);
EXPORT_SYMBOL(chal_audio_hspath_mute);
EXPORT_SYMBOL(chal_audio_hspath_set_gain);
EXPORT_SYMBOL(chal_audio_hspath_set_bits_per_sample);
EXPORT_SYMBOL(chal_audio_hspath_set_mono_stereo);
EXPORT_SYMBOL(chal_audio_hspath_set_pack);
EXPORT_SYMBOL(chal_audio_hspath_clr_fifo);
EXPORT_SYMBOL(chal_audio_hspath_set_fifo_thres);
EXPORT_SYMBOL(chal_audio_hspath_read_fifo_status);
EXPORT_SYMBOL(chal_audio_hspath_read_int_status);
EXPORT_SYMBOL(chal_audio_hspath_write_fifo);
EXPORT_SYMBOL(chal_audio_hspath_sdm_set_dither_poly);
EXPORT_SYMBOL(chal_audio_hspath_sdm_set_dither_seed);
EXPORT_SYMBOL(chal_audio_hspath_hs_supply_ctrl);
EXPORT_SYMBOL(chal_audio_hspath_hs_supply_thres);
EXPORT_SYMBOL(chal_audio_hspath_eanc_in);
EXPORT_SYMBOL(chal_audio_hspath_sidetone_in);
EXPORT_SYMBOL(chal_audio_hspath_int_clear);
EXPORT_SYMBOL(chal_audio_hspath_sdm_set_coef);
EXPORT_SYMBOL(chal_audio_hspath_set_dac_pwr);
EXPORT_SYMBOL(chal_audio_hspath_set_filter);
EXPORT_SYMBOL(chal_audio_hspath_sdm_enable_dither);
EXPORT_SYMBOL(chal_audio_hspath_sdm_enable_dither_gain);
EXPORT_SYMBOL(chal_audio_hspath_sdm_set_dither_strength);
