 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_stpath_enable(CHAL_HANDLE handle, uint16_t enable)
 * 
...
/*============================================================================*/
void chal_audio_stpath_enable(CHAL_HANDLE handle, uint16_t enable)
{
...
void chal_audio_stpath_load_filter(CHAL_HANDLE handle, uint32_t *coeff, uint32_t length )
{
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_stpath_set_gain(CHAL_HANDLE handle, uint32_t gain)
 * 
...
void chal_audio_stpath_set_gain(CHAL_HANDLE handle, uint32_t gain)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->sdt_base;
    uint32_t     reg_val = 0;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_stpath_set_sofslope(CHAL_HANDLE handle, uint16_t enable, uint16_t linear, uint16_t slope)
 * 
...
void chal_audio_stpath_set_sofslope(CHAL_HANDLE handle, uint16_t sof_slope, uint16_t linear, uint32_t slope)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->sdt_base;
    uint32_t     reg_val = 0;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_stpath_set_sofslope(CHAL_HANDLE handle, uint16_t clipping, uint16_t dis_filter, uint16_t gain_bypass)
 * 
 *  Description:  Set the soft slope gain parameters
 * 
 *  Parameters:   handle - audio chal handle.
...
void chal_audio_stpath_config_misc(CHAL_HANDLE handle, uint16_t clipping, uint16_t dis_filter, uint16_t gain_bypass)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->sdt_base;
    uint32_t     reg_val = 0;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_stpath_set_filter_taps(CHAL_HANDLE handle, uint16_t lower_taps, uint16_t upper_taps)
 * 
 *  Description:  Set the soft slope gain parameters
 * 
 *  Parameters:   handle - audio chal handle.
 ...
 * ============================================================================
 */
void chal_audio_stpath_int_enable(CHAL_HANDLE handle, uint16_t thr_int_enable, uint16_t err_int_enable )
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->sdt_base;
    uint32_t reg_val;
                                                                                        ...
                                                                                        uint32_t *dma_addr )
{
    ...
    *dma_addr = (uint32_t)(base) + SDT_SDT_OUTPUTFIFO_OFFSET;
...
void chal_audio_stpath_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits)
{
  (void)handle;
  (void)bits;
...
void chal_audio_stpath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2 )
{
    uint32_t     reg_val;
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->sdt_base;
 ...
 * ============================================================================
 * 
 *  Function Name: uint32_t chal_audio_stpath_read_fifo_status(CHAL_HANDLE handle)
 * 
...
uint32_t chal_audio_stpath_read_fifo_status(CHAL_HANDLE handle)
{
    uint32_t     base =    ((ChalAudioCtrlBlk_t*)handle)->sdt_base;
    uint32_t     sdt_status = 0;
    uint32_t     status = 0;
 ...
 * ============================================================================
 * 
 *  Function Name: uint32_t chal_audio_stpath_read_fifo(CHAL_HANDLE handle,
...
uint32_t chal_audio_stpath_read_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_udf)
{
    uint32_t n;
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->sdt_base;
 ...
 * ============================================================================
 * 
 *  Function Name: uint32_t chal_audio_stpath_read_int_status(CHAL_HANDLE handle)
 * 
...
uint32_t chal_audio_stpath_read_int_status(CHAL_HANDLE handle)
{
    uint32_t     status = 0;
    (void)handle;
 ...
 * ============================================================================
 * 
 *  Function Name: void chal_audio_stpath_int_clear(CHAL_HANDLE handle, uint16_t thr_int_enable, uint16_t err_int_enable )
 * 
...
EXPORT_SYMBOL(chal_audio_stpath_set_filter_taps);
