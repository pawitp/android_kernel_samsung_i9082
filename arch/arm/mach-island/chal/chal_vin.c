...
void chal_audio_vinpath_select_primary_mic( CHAL_HANDLE handle,  uint16_t digital_mic )
{
 ...
 * ============================================================================
 *
 *  Function Name: chal_audio_vinpath_digi_mic_enable(CHAL_HANDLE handle, uint16_t enable)
 *
 ...
 * ============================================================================
 */
void chal_audio_vinpath_digi_mic_enable(CHAL_HANDLE handle, uint16_t enable)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t reg_val;
 ...
 * ============================================================================
 *
 *  Function Name: chal_audio_vinpath_digi_mic_disable(CHAL_HANDLE handle, uint16_t enable)
 *
 ...
 * ============================================================================
 */
void chal_audio_vinpath_digi_mic_disable(CHAL_HANDLE handle, uint16_t path)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t reg_val;
    uint32_t mask;
 ...
 * ============================================================================
 */
void chal_audio_vinpath_int_enable(CHAL_HANDLE handle, uint16_t thr_int_enable, uint16_t err_int_enable )
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t reg_val;
 ...
 * ============================================================================
 */
void chal_audio_vinpath_left_int_enable(CHAL_HANDLE handle, uint16_t thr_int_enable, uint16_t err_int_enable )
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t reg_val;
                                                                                        ...
                                                                                        uint32_t *dma_addr )
{
    ...
    *dma_addr = (uint32_t)(base) + AUDIOH_VIN_FIFOR_DATA0_OFFSET;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_vinpath_left_get_dma_port_addr(CHAL_HANDLE handle,
 *                                                                                           uint32_t *dma_addr)
 *
 *  Description:  Get the DMA port address on vocie in path
 *
...
void chal_audio_vinpath_left_get_dma_port_addr( CHAL_HANDLE handle,
                                                                                        uint32_t *dma_addr )
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;

    *dma_addr = (uint32_t)(base) + AUDIOH_VIN_FIFOL_DATA0_OFFSET;
 ...
 * ============================================================================
 *
 *  Function Name: uint32_t chal_audio_vinpath_get_dma_port_addr_offset()
 *
 ...
 * ============================================================================
 */
uint32_t chal_audio_vinpath_get_dma_port_addr_offset( void )
{
 ...
 * ============================================================================
 *
 *  Function Name: uint32_t chal_audio_vinpath_left_get_dma_port_addr_offset()
 *
 ...
 * ============================================================================
 */
uint32_t chal_audio_vinpath_left_get_dma_port_addr_offset( void )
{
...
void chal_audio_vinpath_set_bits_per_sample(CHAL_HANDLE handle, uint16_t bits)
{
   uint32_t     reg_val;
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
...
void chal_audio_vinpath_set_fifo_thres(CHAL_HANDLE handle, uint16_t thres, uint16_t thres_2 )
{
    uint32_t     reg_val;
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 *
 *  Function Name: uint32_t chal_audio_vinpath_read_fifo_status(CHAL_HANDLE handle)
 *
...
uint32_t chal_audio_vinpath_read_fifo_status(CHAL_HANDLE handle)
{
    uint32_t     base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t     status = 0;
...
uint32_t chal_audio_vinpath_left_read_fifo_status(CHAL_HANDLE handle)
{
    uint32_t     base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t     status = 0;
 ...
 * ============================================================================
 *
 *  Function Name: uint32_t chal_audio_vinpath_read_fifo(CHAL_HANDLE handle,
...
uint32_t chal_audio_vinpath_read_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_udf)
{
    uint32_t n;
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 *
 *  Function Name: uint32_t chal_audio_vinpath_left_read_fifo(CHAL_HANDLE handle,
 *                         uint32_t *src, uint32_t length)
 *
 *  Description:  Read the data from FIFO on voice input path
 *
...
uint32_t chal_audio_vinpath_left_read_fifo(CHAL_HANDLE handle, uint32_t *src, uint32_t length, _Bool ign_udf)
{
    uint32_t n;
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 *
 *  Function Name: uint32_t chal_audio_vinpath_read_int_status(CHAL_HANDLE handle)
 *
...
uint32_t chal_audio_vinpath_read_int_status(CHAL_HANDLE handle)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t     status = 0;
    uint32_t     reg_val = 0;
 ...
 * ============================================================================
 *
 *  Function Name: uint32_t chal_audio_vinpath_left_read_int_status(CHAL_HANDLE handle) (LEFT)
 *
 *  Description:  Read the interrupt status for the Voice In path
 *
 *  Parameters:   handle      - audio chal handle.
...
uint32_t chal_audio_vinpath_left_read_int_status(CHAL_HANDLE handle)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t     status = 0;
    uint32_t     reg_val = 0;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_vinpath_int_clear(CHAL_HANDLE handle, uint16_t thr_int_enable, uint16_t err_int_enable )
 *
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_vinpath_left_int_clear(CHAL_HANDLE handle, uint16_t thr_int_enable, uint16_t err_int_enable )
 *
 *  Description:  Clear interrupt on voice in path
 *
 *  Parameters:   handle      : the voice input pathhandle.
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_vinpath_set_cic_scale(CHAL_HANDLE handle,uint32_t dmic3_scale, uint32_t dmic4_scale)
 *
...
void chal_audio_vinpath_set_cic_scale(CHAL_HANDLE handle, uint32_t dmic1_scale, uint32_t dmic2_scale)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
 ...
 * ============================================================================
 *
 *  Function Name: chal_audio_vinpath_set_digimic_clkdelay(CHAL_HANDLE handle, uint16_t enable)
 *
 ...
 * ============================================================================
 */
void chal_audio_vinpath_set_digimic_clkdelay(CHAL_HANDLE handle, uint16_t delay)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t reg_val;
 ...
 * ============================================================================
 *
 *  Function Name: void chal_audio_vinpath_set_filter(CHAL_HANDLE handle, uint16_t filter)
 *
...
/*============================================================================*/
void chal_audio_vinpath_set_filter(CHAL_HANDLE handle, uint16_t filter)
{
    uint32_t base =    ((ChalAudioCtrlBlk_t*)handle)->audioh_base;
    uint32_t reg_val;
...
EXPORT_SYMBOL(chal_audio_vinpath_left_get_dma_port_addr);
