...
static int __init early_init_dt_scan_kona_root(unsigned long node,
...
static int __init parse_tag_dt(const struct tag *tag)
{
	...
	initial_boot_params =
		(struct boot_param_header *)tag->u.cmdline.cmdline;
