...
/* osdw_dsp_drv.c includes this file which has dependency on chal_intc_int.h. chal_intc_int.h expects
some register offsets which are not defined for capri. to avoid compilation error,included it*/
