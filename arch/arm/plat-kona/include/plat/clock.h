...
#define CCU_REG_ADDR(ccu, offset)	((void __iomem *) \
					(ccu->ccu_clk_mgr_base + offset))
...
struct ccu_clk_ops
{
	...
	int (*set_freq_policy)(struct ccu_clk *ccu_clk, int policy_id, int freq_id, int opp_inx);
