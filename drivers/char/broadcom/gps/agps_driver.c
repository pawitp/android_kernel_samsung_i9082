...
static int __init GPS_KERNEL_ModuleInit(void)
{
	...
	GPS_TRACE((GPS_LOG_LEVEL "enter GPS_KERNEL_ModuleInit()\n"));
	...
	GPS_TRACE((GPS_LOG_LEVEL "exit sucessfuly GPS_KERNEL_ModuleInit()\n"));
	return 0;
}
...
{
	GPS_TRACE((GPS_LOG_LEVEL "GPS_KERNEL_ModuleExit()\n"));
