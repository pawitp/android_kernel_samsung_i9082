...
extern "C" {
	...
	void IPC_TraceBSP(UInt32 Channel, char *Function, char *Text, UInt32 P1,
			  UInt32 P2, UInt32 P3, UInt32 P4);
#define IPC_TRACE(Channel, Function, Text, P1, P2, P3, P4)		\
	do {								\
		if (TraceChannel[Channel])				\
			IPC_TraceBSP(Channel, Function, Text,		\
				     (IPC_U32) P1, (IPC_U32) P2,	\
				     (IPC_U32) P3, (IPC_U32) P4);	\
	} while (0)
#else

#ifdef FUSE_COMMS_PROCESSOR
	void IPC_TraceComms(char *Text, IPC_U32 P1, IPC_U32 P2, IPC_U32 P3,
			    IPC_U32 P4);
...
#define IPC_TRACE(Channel, Function, Text, P1, P2, P3, P4)		\
	...
	void IPC_TraceApps(IPC_U32 Channel, char *Text, IPC_U32 P1, IPC_U32 P2,
			   IPC_U32 P3, IPC_U32 P4);
#ifdef UNDER_LINUX
	void IPC_TraceLinux(IPC_U32 Channel, char *Function, char *Text,
			    IPC_U32 P1, IPC_U32 P2, IPC_U32 P3, IPC_U32 P4);
#endif
...
#define IPC_TRACE(Channel, Function, Text, P1, P2, P3, P4)		\
	do {								\
		if (TraceChannel[Channel])				\
			IPC_TraceLinux(Channel, Function, Text,		\
				       (IPC_U32) P1, (IPC_U32) P2,	\
				       (IPC_U32) P3, (IPC_U32) P4);	\
	} while (0)
#else
#define IPC_TRACE(Channel, Function, Text, P1, P2, P3, P4)		\
	do {								\
		if (TraceChannel[Channel])				\
			IPC_TraceApps(Channel, Function##" "##Text,	\
				      (IPC_U32) P1, (IPC_U32) P2,	\
				      (IPC_U32) P3, (IPC_U32) P4);	\
	} while (0)
#endif				/* UNDER_LINUX */
