...
/*init C0 values by default */
	[PMU_REG_RFOPMODCTRL] =	{.map = 0x00,
		.addr = 0xA2, .mask = 0xFF, .ro = 0},
	[PMU_REG_HV1OPMODCTRL] = {.map = 0x00,
		.addr = 0xA0, .mask = 0xFF, .ro = 0},
	...
	/*init C0 values by default */
	[PMU_REG_RFLDOCTRL] = {.map = 0x00,
		.addr = 0xB3, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO1CTRL] = {.map = 0x00,
		.addr = 0xB1, .mask = 0x07, .ro = 0},

	[PMU_REG_CAMLDOCTRL] = {.map = 0x00,
		.addr = 0xB2, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO2CTRL] = {.map = 0x00,
		.addr = 0xB4, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO3CTRL] = {.map = 0x00,
		.addr = 0xB5, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO4CTRL] = {.map = 0x00,
		.addr = 0xB6, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO5CTRL] = {.map = 0x00,
		.addr = 0xB7, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO6CTRL] = {.map = 0x00,
		.addr = 0xB8, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO7CTRL] = {.map = 0x00,
		.addr = 0xB9, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO8CTRL] = {.map = 0x00,
		.addr = 0xBA, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO9CTRL] = {.map = 0x00,
		.addr = 0xBB, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO10CTRL] = {.map = 0x00,
		.addr = 0xBC, .mask = 0x07, .ro = 0},
	[PMU_REG_SIMLDOCTRL] = {.map = 0x00,
		.addr = 0xBD, .mask = 0x07, .ro = 0},
	...
	/* audio */
	[PMU_REG_IHFTOP_IHF_IDDQ] = {.map = 0x01,
		.addr = 0x80, .mask = 0x01, .ro = 0},
	[PMU_REG_IHFLDO_PUP] = {.map = 0x01,
		.addr = 0x82, .mask = 0x01, .ro = 0},
	[PMU_REG_IHFPOP_PUP] = {.map = 0x01,
		.addr = 0x83, .mask = 0x08,
				.ro = 0, .shift = 3},
	[PMU_REG_IHFAUTO_SEQ] = {.map = 0x01, .addr = 0x83, .mask = 0x40,
				 .ro = 0, .shift = 6},
	[PMU_REG_IHFPGA2_GAIN] = {.map = 0x01,
		.addr = 0x8E, .mask = 0x3F, .ro = 0, .shift = 0},
	[PMU_REG_HIGH_GAIN_MODE] =	{.map = 0x01, .addr = 0x8D,
		.mask = 0x08, .ro = 0, .shift = 3},
	[PMU_REG_IHF_SC_EDISABLE] = {.map = 0x01,
		.addr = 0x9C, .mask = 0x04, .ro = 0},
	[PMU_REG_HS_SC_EDISABLE] = {.map = 0x01,
		.addr = 0x9C, .mask = 0x02, .ro = 0},
	[PMU_REG_HSPUP_IDDQ_PWRDWN] = {.map = 0x01,
		.addr = 0xAA, .mask = 0x10, .ro = 0, .shift = 4},
	[PMU_REG_HSPUP_HS_PWRUP] = {.map = 0x01,
		.addr = 0xAB, .mask = 0x40, .ro = 0, .shift = 6},
	...
	[PMU_REG_HSPGA1] = {.map = 0x01,
		.addr = 0xA6, .mask = 0xFF, .ro = 0},
	[PMU_REG_HSPGA2] = {.map = 0x01,
		.addr = 0xA7, .mask = 0xFF, .ro = 0},
	[PMU_REG_HSPGA1_LGAIN] = {
		.map = 0x01, .addr = 0xA6, .mask = 0x3F, .ro = 0},
	[PMU_REG_HSPGA2_RGAIN] = {
		.map = 0x01, .addr = 0xA7, .mask = 0x3F, .ro = 0},
	[PMU_REG_HSDRV_DISSC] = {.map = 0x01,
		.addr = 0xA3, .mask = 0x10, .ro = 0, .shift = 4},
	[PMU_REG_IHFALC_BYPASS] = {.map = 0x01,
		.addr = 0x89, .mask = 0x04, .ro = 0, .shift = 2},
	...
	[PMU_REG_IHFPOP_EN] =	{.map = 0x01, .addr = 0x83, .mask = 0x04,
				 .ro = 0, .shift = 2},
	[PMU_REG_IHFDRVCLAMP_DIS] = {.map = 0x01,
		.addr = 0x8C, .mask = 0x08,
				 .ro = 0, .shift = 3},
	[PMU_REG_IHFCAL_SEL] =	{.map = 0x01, .addr = 0x8C, .mask = 0x10,
				 .ro = 0, .shift = 4},
	[PMU_REG_IHFPSRCAL_PUP] = {.map = 0x01,
		.addr = 0x85, .mask = 0x01,
				 .ro = 0, .shift = 0},
	/* charge */
	[PMU_REG_CHRGR_USB_EN] =	{.map = 0x00, .addr = 0x52, .mask = 0x01, .ro = 0, .shift = 0},
	[PMU_REG_CHRGR_USB_MAINT] = {.map = 0x00,
		.addr = 0x52, .mask = 0x02, .ro = 0, .shift = 1},
	...
	[PMU_REG_FG_CAL] = {.map = 0x01,
		.addr = 0x41, .mask = 0x02, .ro = 0, .shift = 1},
	[PMU_REG_FG_FRZREAD] =		{.map = 0x01, .addr = 0x41, .mask = 0x20, .ro = 0, .shift = 5},
	[PMU_REG_FG_FRZSMPL] =		{.map = 0x01, .addr = 0x41, .mask = 0x40, .ro = 0, .shift = 6},
	[PMU_REG_FG_OFFSET0] = {.map = 0x01,
		.addr = 0x54, .mask = 0xFF, .ro = 1, .shift = 6},
	[PMU_REG_FG_OFFSET1] = {.map = 0x01,
		.addr = 0x55, .mask = 0xFF, .ro = 1, .shift = 6},
	[PMU_REG_FG_GAINTRIM] = {.map = 0x01,
		.addr = 0x45, .mask = 0xFF, .ro = 0, .shift = 0},
	[PMU_REG_FG_DELTA] = {.map = 0x01,
		.addr = 0x5A, .mask = 0xFF, .ro = 0, .shift = 0},
	[PMU_REG_FG_CAP] = {.map = 0x01,
		.addr = 0x59, .mask = 0xFF, .ro = 0, .shift = 0},
	[PMU_REG_FG_CIC] = {.map = 0x01,
		.addr = 0x43, .mask = 0xFF, .ro = 0, .shift = 0},
	/* usb control */
	[PMU_REG_OTG_VBUS_PULSE] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 0},
	[PMU_REG_OTG_VBUS_BOOST] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 2},
	[PMU_REG_OTG_VBUS_DISCHRG] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 1},
	[PMU_REG_OTG_ENABLE] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 6},
	[PMU_REG_ADP_SENSE] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 4},
	[PMU_REG_ADP_COMP_DB_TM] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 0},
	[PMU_REG_ADP_PRB] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 0},
	[PMU_REG_ADP_CAL_PRB] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 0},
	[PMU_REG_ADP_PRB_MOD] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 1},
	[PMU_REG_ADP_PRB_CYC_TIME] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 3},
	[PMU_REG_ADP_COMP_METHOD] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 5},
	[PMU_REG_ADP_ENABLE] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 3},
	[PMU_REG_ADP_PRB_COMP] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 0},
	[PMU_REG_ADP_PRB_REG_RST] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 4},
	[PMU_REG_ADP_SNS_COMP] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 1},
	[PMU_REG_ADP_SNS_AON] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 2},
	/* usb status */
	...
	[PMU_REG_OTG_STATUS_SESS_END] =	{.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 2},
	[PMU_REG_ADP_STATUS_ATTACH_DET] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 3},
	[PMU_REG_ADP_STATUS_SNS_DET] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 4},
	[PMU_REG_ADP_STATUS_RISE_TIMES_LSB] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 0},
	[PMU_REG_ADP_STATUS_RISE_TIMES_MSB] = {.map = 0,
		.addr = 0, .mask = 0x00, .ro = 0, .shift = 4},
	/* BC ctrl and status */
...
static const struct bcmpmu_irq_map bcm59039_irq_map[PMU_IRQ_MAX] = {
	...
	[PMU_IRQ_VBUS_1V5_F] = {.int_addr = 0x33,
		.mask_addr = 0x43, .bit_mask = 0x04},
	[PMU_IRQ_VBUS_4V5_F] = {.int_addr = 0x33,
		.mask_addr = 0x43, .bit_mask = 0x08},
	...
	[PMU_IRQ_JIG_UART_INS] = {.int_addr = 0x37,
		.mask_addr = 0x47, .bit_mask = 0x04},
...
static const struct bcmpmu_env_info bcm59039_env_reg_map[PMU_ENV_MAX] = {
	...
	[PMU_ENV_P_UBPD_INT] = {.regmap = {.addr = 0xE1,
