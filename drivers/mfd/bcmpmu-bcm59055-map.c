...
static const struct bcmpmu_reg_map bcm59055_reg_map[PMU_REG_MAX] = {//revisit
	...
	[PMU_REG_IHFPOP_PUP] =		{.map = 0x01, .addr = 0x83, .mask = 0x7F, .ro = 0},
	...
	[PMU_REG_CHRGR_EOC] =		{.map = 0x00, .addr = 0x00, .mask = 0x00, .ro = 0, .shift = 0},
	/* fuel gauge */
	[PMU_REG_FG_ACCM0] =		{.map = 0x01, .addr = 0xC9, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_ACCM1] =		{.map = 0x01, .addr = 0xC8, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_ACCM2] =		{.map = 0x01, .addr = 0xC7, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_ACCM3] =		{.map = 0x01, .addr = 0xC6, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_CNT0] =		{.map = 0x01, .addr = 0xCB, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_CNT1] =		{.map = 0x01, .addr = 0xCA, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_SLEEPCNT0] =	{.map = 0x01, .addr = 0xCD, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_SLEEPCNT1] =	{.map = 0x01, .addr = 0xCC, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_HOSTEN] =		{.map = 0x01, .addr = 0xC0, .mask = 0x01, .ro = 0, .shift = 0},
	...
	[PMU_REG_OTG_VBUS_DISCHRG] =	{.map = 0, .addr = 0x70, .mask = 0x02, .ro = 0, .shift = 1},
	[PMU_REG_OTG_ENABLE] =		{.map = 0, .addr = 0x70, .mask = 0x40, .ro = 0, .shift = 6},
	[PMU_REG_ADP_SENSE] =		{.map = 0, .addr = 0x71, .mask = 0x10, .ro = 0, .shift = 4},
	[PMU_REG_ADP_COMP_DB_TM] =	{.map = 0, .addr = 0x71, .mask = 0x03, .ro = 0, .shift = 0},
	[PMU_REG_ADP_SNS_TM] =	{.map = 0, .addr = 0, .mask = 0,
		.ro = 0, .shift = 0},
	[PMU_REG_ADP_PRB] =		{.map = 0, .addr = 0x7A, .mask = 0x01, .ro = 0, .shift = 0},
	[PMU_REG_ADP_CAL_PRB] =		{.map = 0, .addr = 0x35, .mask = 0xFF, .ro = 0, .shift = 0},
	[PMU_REG_ADP_PRB_MOD] =		{.map = 0, .addr = 0x7A, .mask = 0x06, .ro = 0, .shift = 1},
	[PMU_REG_ADP_PRB_CYC_TIME] =	{.map = 0, .addr = 0x71, .mask = 0x08, .ro = 0, .shift = 3},
	[PMU_REG_ADP_COMP_METHOD] =	{.map = 0, .addr = 0x7B, .mask = 0x60, .ro = 0, .shift = 5},
	[PMU_REG_ADP_ENABLE] =		{.map = 0, .addr = 0x7B, .mask = 0x08, .ro = 0, .shift = 3},
	[PMU_REG_ADP_PRB_COMP] =	{.map = 0, .addr = 0x7B, .mask = 0x01, .ro = 0, .shift = 0},
	[PMU_REG_ADP_PRB_REG_RST] =	{.map = 0, .addr = 0x7B, .mask = 0x10, .ro = 0, .shift = 4},
	...
	[PMU_REG_ADP_STATUS_ATTACH_DET] =	{.map = 0, .addr = 0x70, .mask = 0x04, .ro = 0, .shift = 3},
	[PMU_REG_ADP_STATUS_SNS_DET] =		{.map = 0, .addr = 0x70, .mask = 0x10, .ro = 0, .shift = 4},
	[PMU_REG_ADP_STATUS_RISE_TIMES_LSB] =	{.map = 0, .addr = 0x73, .mask = 0xFF, .ro = 0, .shift = 0},
	[PMU_REG_ADP_STATUS_RISE_TIMES_MSB] =	{.map = 0, .addr = 0x74, .mask = 0x30, .ro = 0, .shift = 4},
	/* interrupt */
...
static const struct bcmpmu_irq_map bcm59055_irq_map[PMU_IRQ_MAX] = {//revisit
	[PMU_IRQ_RTC_ALARM] =		{.int_addr = 0x37, .mask_addr = 0x47, .bit_mask = 0x01},
	[PMU_IRQ_RTC_SEC] =		{.int_addr = 0x37, .mask_addr = 0x47, .bit_mask = 0x02},
	[PMU_IRQ_RTC_MIN] =		{.int_addr = 0x37, .mask_addr = 0x47, .bit_mask = 0x04},
	[PMU_IRQ_RTCADJ] =		{.int_addr = 0x37, .mask_addr = 0x47, .bit_mask = 0x08},
	[PMU_IRQ_BATINS] =		{.int_addr = 0x30, .mask_addr = 0x40, .bit_mask = 0x10},
	[PMU_IRQ_BATRM] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_GBAT_PLUG_IN] =	{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_SMPL_INT] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_USBINS] =		{.int_addr = 0x31, .mask_addr = 0x41, .bit_mask = 0x10},
	...
	[PMU_IRQ_RESUME_VBUS] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_CHG_HW_TTR_EXP] =	{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_CHG_HW_TCH_EXP] =	{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_CHG_SW_TMR_EXP] =	{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_CHGDET_LATCH] =	{.int_addr = 0x34, .mask_addr = 0x44, .bit_mask = 0x02},
	[PMU_IRQ_CHGDET_TO] =		{.int_addr = 0x34, .mask_addr = 0x44, .bit_mask = 0x04},
	[PMU_IRQ_MBTEMPLOW] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_MBTEMPHIGH] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_MBOV] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_MBOV_DIS] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_USBOV_DIS] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_CHGERRDIS] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_VBUS_1V5_R] =		{.int_addr = 0x33, .mask_addr = 0x43, .bit_mask = 0x20},
	[PMU_IRQ_VBUS_4V5_R] =		{.int_addr = 0x33, .mask_addr = 0x43, .bit_mask = 0x10},
	[PMU_IRQ_VBUS_1V5_F] =		{.int_addr = 0x33, .mask_addr = 0x43, .bit_mask = 0x02},
	[PMU_IRQ_VBUS_4V5_F] =		{.int_addr = 0x33, .mask_addr = 0x43, .bit_mask = 0x01},
	[PMU_IRQ_MBWV_R_10S_WAIT] =	{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_BBLOW] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_LOWBAT] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_VERYLOWBAT] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_RTM_DATA_RDY] =	{.int_addr = 0x38, .mask_addr = 0x48, .bit_mask = 0x01},
	[PMU_IRQ_RTM_IN_CON_MEAS] =	{.int_addr = 0x38, .mask_addr = 0x48, .bit_mask = 0x02},
	[PMU_IRQ_RTM_UPPER] =		{.int_addr = 0x38, .mask_addr = 0x48, .bit_mask = 0x04},
	[PMU_IRQ_RTM_IGNORE] =		{.int_addr = 0x38, .mask_addr = 0x48, .bit_mask = 0x08},
	[PMU_IRQ_RTM_OVERRIDDEN] =	{.int_addr = 0x38, .mask_addr = 0x48, .bit_mask = 0x10},
	[PMU_IRQ_AUD_HSAB_SHCKT] =	{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_AUD_IHFD_SHCKT] =	{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_MBC_TF] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_CSROVRI] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_IOSROVRI] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_SDSROVRI] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_ASROVRI] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_UBPD_CHG_F] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_ACD_INS] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_ACD_RM] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_PONKEYB_HOLD] =	{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_PONKEYB_F] =		{.int_addr = 0x30, .mask_addr = 0x40, .bit_mask = 0x01},
	[PMU_IRQ_PONKEYB_R] =		{.int_addr = 0x30, .mask_addr = 0x40, .bit_mask = 0x02},
	[PMU_IRQ_PONKEYB_OFFHOLD] =	{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_PONKEYB_RESTART] =	{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_IDCHG] =		{.int_addr = 0x34, .mask_addr = 0x44, .bit_mask = 0x01},
	[PMU_IRQ_JIG_USB_INS] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_UART_INS] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
	[PMU_IRQ_ID_INS] =		{.int_addr = 0x00, .mask_addr = 0x00, .bit_mask = 0x00},
...
static const struct bcmpmu_env_info bcm59055_env_reg_map[PMU_ENV_MAX] = {//revisit
	...
	[PMU_ENV_WAC_VALID] = 		{.regmap = {.addr = 0xE1, .mask = 0x40, .shift = 6, .ro = 1}, .bitmask = PMU_ENV_BITMASK_WAC_VALID},
	[PMU_ENV_USB_VALID] = 		{.regmap = {.addr = 0xE1, .mask = 0x80, .shift = 7, .ro = 1}, .bitmask = PMU_ENV_BITMASK_USB_VALID},
...
static const struct bcmpmu_adc_map bcm59055_adc_map[PMU_ADC_MAX] = {//revisit
	...
	[PMU_ADC_VBUS] =		{.map = 0, .addr0 = 0x89, .addr1 = 0x88, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x03, .vrng = 14400},
	[PMU_ADC_ID] =			{.map = 0, .addr0 = 0x8B, .addr1 = 0x8A, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x04, .vrng = 4800},
	[PMU_ADC_NTC] =			{.map = 0, .addr0 = 0x8D, .addr1 = 0x8C, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x05, .vrng = 1200},
	[PMU_ADC_BSI] =			{.map = 0, .addr0 = 0x8F, .addr1 = 0x8E, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x06, .vrng = 1200},
	[PMU_ADC_32KTEMP] =		{.map = 0, .addr0 = 0x93, .addr1 = 0x92, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x08, .vrng = 1200},
	[PMU_ADC_PATEMP] =		{.map = 0, .addr0 = 0x95, .addr1 = 0x94, .dmask = 0x3FF, .vmask = 0x0400, .rtmsel = 0x09, .vrng = 1200},
