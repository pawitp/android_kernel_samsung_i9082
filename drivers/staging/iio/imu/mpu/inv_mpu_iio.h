...
// IKR Add for Interrupt Pin Checking 
#define FEATURE_IKR_INTERRUPT_TEST
/**
...
#define TIMESTAMP_FIFO_SIZE 16
    ...
    int  interrupt_count;                  /*IKR : Interrupt Count, add for inv_interrupt_test function */ 
    bool interrupt_test_mode;              /*IKR : Interrupt Test Mode, if it is set to true , int_count will be increased */
