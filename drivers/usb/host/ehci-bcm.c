...
struct ehci_bcm_usb_cfg {
	void *virt_reg_base;
	struct usb_hcd *hcd;
};

extern int usb_disabled(void);
static int ehci_bcm_hcd_init(struct usb_hcd *hcd);

static const struct hc_driver ehci_bcm_hcd_driver = {
...
int ehci_bcm_hcd_init(struct usb_hcd *hcd)
{
...
{
	struct ehci_bcm_usb_cfg *usb = platform_get_drvdata(pdev);
