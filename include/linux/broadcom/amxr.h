...
*  interpfac/decimfac.
*/
typedef void (*AMXR_RESAMP_FNC) (int16_t *insamp,
				    /**< (i) Ptr to input samples */
				 int16_t *outsamp,
				    /**< (o) Ptr to output samples */
				 int16_t numsamp,
				    /**< (i) Number of samples to generate */
				 const int16_t *filtcoeff,
				    /**< (i) Ptr to filter coefficients */
				 int filtlen,
				    /**< (i) Filter length */
				 int interpfac,
...
*     -ve         On general failure
*/
	int amxrFreeClient(AMXR_HDL hdl
				    /**< (i) client handle */
	    );
...
*     -ve      Other errors
*/
	int amxrQueryPortByName(AMXR_HDL hdl,
...
*     -ve   Failure code
*/
	int amxrGetPortInfo(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
			    AMXR_PORT_ID port,
				    /**< (i) Port id */
			    AMXR_PORT_INFO * info
				    /**< (o) Ptr to port info structure */
	    );
...
*     -ve   Failure code
*/
	static inline int amxrGetPortInfoByName(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
						const char *name,
				    /**< (i) Port name string */
						AMXR_PORT_INFO * info
...
*     -ve   Failure code
*/
	int amxrGetInfo(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
			AMXR_INFO * info
				    /**< (o) Ptr to info structure */
	    );
...
*     -ve         Other errors
*/
	int amxrSetCnxLoss(AMXR_HDL hdl,
				    /**< (i) client handle */
...
*     -ve         Other errors
*/
	static inline int amxrSetCnxLossByName(AMXR_HDL hdl,
				    /**< (i) client handle */
					       const char *src_name,
				    /**< (i) source port name */
					       const char *dst_name,
...
*     -ve         On general failure
*/
	static inline int amxrConnectByName(AMXR_HDL hdl,
				    /**< (i) client handle */
					    const char *src_name,
				    /**< (i) source port name */
					    const char *dst_name,
...
*     -ve         On general failure
*/
	static inline int amxrConnectAll(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
					 AMXR_PORT_ID port1,
				    /**< (i) First port id */
					 AMXR_PORT_ID port2,
		...
		if (!err) {
			...
			desc =
			    AMXR_CREATE_DESC(cnx_type, dst_chans, dst_idx,
					     src_chans, src_idx);
...
*     -ve         On general failure
*/
	static inline int amxrConnectAllByName(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
...
*     -ve         On general failure
*/
	int amxrDisconnect(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
			   AMXR_PORT_ID src_port,
				    /**< (i) source port id */
			   AMXR_PORT_ID dst_port
...
*     -ve         On general failure
*/
	static inline int amxrDisconnectByName(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
					       const char *src_name,
				    /**< (i) source port name */
					       const char *dst_name
...
*     -ve         On general failure
*/
	static inline int amxrDisconnectAll(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
					    AMXR_PORT_ID port1,
				    /**< (i) First port id */
					    AMXR_PORT_ID port2
...
*     -ve         On general failure
*/
	static inline int amxrDisconnectAllByName(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
						  const char *port1_name,
				    /**< (i) First port name */
						  const char *port2_name
...
*     -ve         On general failure
*/
	int amxrGetCnxListBySrc(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
				AMXR_PORT_ID src_port,
				    /**< (i) Source port */
				AMXR_CNXS * cnxlist,
				    /**< (o) Ptr to store cnx list */
				int maxlen
				    /**< (i) Max length in bytes */
	    );
...
*     -ve         On general failure
*/
	static inline int amxrGetCnxListBySrcByName(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
...
*     -ve         On general failure
*/
	int amxrGetCnxListByDst(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
				AMXR_PORT_ID dst_port,
				    /**< (i) Dst port */
				AMXR_CNXS * cnxlist,
...
*     -ve         On general failure
*/
	static inline int amxrGetCnxListByDstByName(AMXR_HDL hdl,
				    /**< (i) Mixer client handle */
						    const char *port_name,
				    /**< (i) Dst port name */
						    AMXR_CNXS * cnxlist,
...
*     -ve      Other errors
*/
int amxrQueryNameById(AMXR_PORT_ID id,
				    /**< (i) Port ID */
		      const char **name
				    /**< (o) Name of port */
);
