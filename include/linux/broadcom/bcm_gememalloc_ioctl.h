...
#define GEMEMALLOC_WRAP_ACQUIRE_BUFFER\
 _IOWR(GEMEMALLOC_WRAP_MAGIC,  1, unsigned long)
#define GEMEMALLOC_WRAP_RELEASE_BUFFER\
 _IOW(GEMEMALLOC_WRAP_MAGIC,  2, unsigned long)
