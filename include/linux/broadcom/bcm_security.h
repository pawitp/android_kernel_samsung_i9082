...
*          The file must match with bcm_security.h in kernel\include\linux\broadcom\
*
****************************************************************************/
...
#define SEC_HDCP_AES_IOC	           _IOWR(BCM_SEC_IOC_MAGIC, 7, \
						sec_hdcp_aes_data_t)
#define SEC_SIMLOCK_IOC_MAXNR			    8
