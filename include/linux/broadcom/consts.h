...
#define FRAME_TP		(*(volatile UInt16*)(TP_BASE_ADDR+0xffff50))
	/* to 0x4ffff70 */
...
#define TP_ECDC_TX_DATA		((volatile UInt16*)(TP_BASE_ADDR+0x600300))
	/* Data sent to Stack (up to 256 bytes per read) */
#define TP_ECDC_RX_DATA		((volatile UInt16*)(TP_BASE_ADDR+0x600400))
	/* Data received from Stack (up to 256 bytes per write) */
...
/* rx DATA buffer address = 0x100 + 68 * 4  = 0x6000210 */
