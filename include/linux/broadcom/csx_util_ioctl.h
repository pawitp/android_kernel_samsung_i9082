...
/* IOCTL numbers */
#define CSX_UTIL_IOCTL_ADD_POINT\
	_IOR(CSX_UTIL_MAGIC_TYPE, CSX_UTIL_CMD_ADD_POINT, CSX_UTIL_IOCTL_ADD_POINT_PARMS)
#define CSX_UTIL_IOCTL_REMOVE_POINT\
	_IOR(CSX_UTIL_MAGIC_TYPE, CSX_UTIL_CMD_REMOVE_POINT, CSX_UTIL_IOCTL_REMOVE_POINT_PARMS)
#define CSX_UTIL_IOCTL_GET_NUM_POINTS\
	_IOR(CSX_UTIL_MAGIC_TYPE, CSX_UTIL_CMD_GET_NUM_POINTS, CSX_UTIL_IOCTL_GET_NUM_POINTS_PARMS)
#define CSX_UTIL_IOCTL_QUERY_ALL\
	_IOR(CSX_UTIL_MAGIC_TYPE, CSX_UTIL_CMD_QUERY_ALL, CSX_UTIL_IOCTL_QUERY_ALL_PARMS)
#define CSX_UTIL_IOCTL_SYNC_ENABLE\
	_IOR(CSX_UTIL_MAGIC_TYPE, CSX_UTIL_CMD_SYNC_ENABLE, CSX_UTIL_IOCTL_SYNC_ENABLE_PARMS)
#define CSX_UTIL_IOCTL_SYNC_DISABLE\
	_IOR(CSX_UTIL_MAGIC_TYPE, CSX_UTIL_CMD_SYNC_DISABLE, CSX_UTIL_IOCTL_SYNC_DISABLE_PARMS)
