...
/* Add your AP Owned property IDs here in ascending order.
    These can be read and written by AP, but only read by the CP */
...
/* Add your CP Owned property IDs here in ascending order.
    These can be read and written by CP, but only read by the AP */
