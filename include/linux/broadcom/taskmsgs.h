...
//*****************************************************************************
	...
	MSG_SMS_SUBMIT_CONCAT_RETRY_REQ = MSG_GRP_INT_SMS_SS + 0x0F,	///<Payload type {::SmsConcatMsgStored_t}
...
/*TASKMSGS_INCLUDE taskmsgs_mmi.i*/
	...
	MSG_SIMULATOR_CC_ISCONNECTEDLINEIDPRESENTALLOWED =
	    MSG_GRP_SIMULATOR_0 + 0x8c,
	...
	MSG_SIMULATOR_DATA_GETGPRSHEADERCOMPRESSION =
	    MSG_GRP_SIMULATOR_0 + 0xdc,
	...
	MSG_SIMULATOR_DATA_SETGPRSHEADERCOMPRESSION =
	    MSG_GRP_SIMULATOR_0 + 0xfe,
	...
	MSG_SIMULATOR_PBK_SENDFINDALPHAMATCHMULTIPLEREQ =
	    MSG_GRP_SIMULATOR_1 + 0xf0,
	...
	MSG_SIMULATOR_PDP_DEACTIVATESNDCPCONNECTION =
	    MSG_GRP_SIMULATOR_1 + 0xfe,
	MSG_SIMULATOR_PDP_GETDEFINEDPDPCONTEXTCIDLIST =
	    MSG_GRP_SIMULATOR_2 + 0x00,
	...
	MSG_SIMULATOR_SENDSMSSRVCENTERNUMBERUPDATEREQ =
	    MSG_GRP_SIMULATOR_2 + 0x4c,
	...
	MSG_SIMULATOR_SIM_SENDREMAININGPINATTEMPTREQ =
	    MSG_GRP_SIMULATOR_2 + 0xa0,
	...
	MSG_SIMULATOR_SIM_SENDWHOLEBINARYEFILEREADREQ =
	    MSG_GRP_SIMULATOR_2 + 0xac,
	...
	MSG_SIMULATOR_SIMLOCKCHANGEPHONELOCKPASSWORD =
	    MSG_GRP_SIMULATOR_2 + 0xb4,
	...
	MSG_SIMULATOR_SS_QUERYCALLINGLINERESTRICTIONSTATUS =
	    MSG_GRP_SIMULATOR_3 + 0x1c,
	MSG_SIMULATOR_SS_QUERYCALLWAITINGSTATUS = MSG_GRP_SIMULATOR_3 + 0x1e,
	MSG_SIMULATOR_SS_QUERYCONNECTEDLINEIDSTATUS =
	    MSG_GRP_SIMULATOR_3 + 0x20,
	MSG_SIMULATOR_SS_QUERYCONNECTEDLINERESTRICTIONSTATUS =
	    MSG_GRP_SIMULATOR_3 + 0x22,
	MSG_SIMULATOR_SS_SENDCALLBARRINGPWDCHANGEREQ =
	    MSG_GRP_SIMULATOR_3 + 0x24,
...
//MSG_GEN_REQ_START = 0x0
	...
	**/
	MSG_SS_QUERYCONNECTEDLINERESTRICTIONSTATUS_REQ =
	    MSG_GRP_CAPI2_SS + 0x16,
	 /** 
...
InterTaskMsg_t *AllocInterTaskMsgFromHeapDbg(MsgType_t msgType,
					     UInt16 dataLength, char *fileName,
					     UInt32 lineNumber);
...
void FreeInterTaskMsgDbg(InterTaskMsg_t * inMsg, char *fileName,
			 UInt32 lineNumber);
#else // #ifdef HISTORY_LOGGING
/**
...
**/
Boolean SYS_RegisterForPredefinedClient(CallbackFunc_t * callback,
					UInt8 clientId, UInt32 eventMask);
...
Boolean SYS_SetRegisteredEventMask(UInt8 clientID, const UInt16 *maskList,
				   UInt8 maskLen);
...
Boolean SYS_SetFilteredEventMask(UInt8 clientID, const UInt16 *maskList,
				 UInt8 maskLen, SysFilterEnable_t enableFlag);
...
/**
	...
	@note
**/
Boolean SYS_EnableFilterMessage(UInt8 clientID, SysFilterEnable_t flag,
				CbFilterQueryCheckFunc_t cbk);
...
Boolean SYS_RegisterGetClientName(UInt8 inClientID, char *clientName,
				  UInt8 clientBufferLen);
Boolean SYS_FindClient(char *clientName, UInt8 *clientList,
		       UInt8 inClientListSize, UInt8 *outClientListSize);
...
**/
UInt8 VccApi_ActivateVmfCtx(ClientInfo_t *inClientInfoPtr, const char *fileName,
			    UInt32 lineNo);
