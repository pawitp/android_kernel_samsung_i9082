...
#define OMX_PLUGIN__COMPONENT_SUPPORTED__MPEG2           "mpeg2"
#define OMX_PLUGIN__COMPONENT_SUPPORTED__WMV3            "wmv3"
...
#define VC_OMX_IOC_COMP_STATUS \
	_IOR(VC_OMX_IOC_MAGIC, 0, struct vc_omx_comp_status)
#define VC_OMX_IOC_ENC_COLOR \
	_IOR(VC_OMX_IOC_MAGIC, 1, struct vc_omx_enc_color)
#define VC_OMX_IOC_AND_EXT \
	_IOR(VC_OMX_IOC_MAGIC, 2, struct vc_omx_and_ext)
