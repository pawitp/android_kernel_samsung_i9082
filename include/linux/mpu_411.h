...
#define MPU_IOCTL_SET_CALIBRATION       _IOW(MPU_IOCTL, 0x90, short[3])
#define MPU_IOCTL_GET_CALIBRATION       _IOR(MPU_IOCTL, 0x91, short[3])
#define MPU_IOCTL_DO_CALIBRATION       _IOR(MPU_IOCTL, 0x92, short[3])
